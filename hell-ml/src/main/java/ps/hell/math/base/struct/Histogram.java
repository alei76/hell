...
public class Histogram {
    ...
    public static double[][] histogram(int[] data, int k) {
        ...
        int min = MathBase.min(data);
        int max = MathBase.max(data);
        int span = max - min + 1;
    ...
    public static double[][] histogram(float[] data, int k) {
        ...
        float min = MathBase.min(data);
        float max = MathBase.max(data);
        float span = max - min;
        if (span == 0) {
            span = k;
        }
    ...
    public static double[][] histogram(double[] data, int k) {
        double min = MathBase.min(data);
        double max = MathBase.max(data);
        double span = max - min;
        if (span == 0) {
            span = k;
        }
    ...
    public static double[] breaks(double[] x, double h) {
        return breaks(MathBase.min(x), MathBase.max(x), h);
    }
    ...
    public static double[] breaks(double[] x, int k) {
        return breaks(MathBase.min(x), MathBase.max(x), k);
    }
    ...
    public static int bins(double[] x, double h) {
        ...
        double max = MathBase.max(x);
        double min = MathBase.min(x);
    ...
    public static int sturges(int n) {
        int k = (int) Math.ceil(MathBase.log2(n) + 1);
        if (k < 5) k = 5;
        return k;
    }
    ...
    public static int scott(double[] x) {
        double h = Math.ceil(3.5 * MathBase.sd(x) / Math.pow(x.length, 1.0/3));
        return bins(x, h);
    }
}
