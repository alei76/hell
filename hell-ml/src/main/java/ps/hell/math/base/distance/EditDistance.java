...
package ps.hell.math.base.distance;
...
public class EditDistance implements Metric<String> {
    ...
    private static class BRF1 implements BRF {
        @Override
        public void f(char[] x, char[] y, int[][] FKP, int ZERO_K, int k, int p) {
            int t = MathBase.max(FKP[k + ZERO_K][p] + 1, FKP[k - 1 + ZERO_K][p], FKP[k + 1 + ZERO_K][p] + 1);
    ...
    private static class BRF2 implements BRF {
        ...
        public void f(char[] x, char[] y, int[][] FKP, int ZERO_K, int k, int p) {
            ...
            t = MathBase.max(FKP[k - 1 + ZERO_K][p], FKP[k + 1 + ZERO_K][p] + 1, t);
