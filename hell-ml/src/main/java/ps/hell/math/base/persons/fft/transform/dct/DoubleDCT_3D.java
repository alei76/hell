...
//		}
//		this.dctSlices = new DoubleDCT_1D(paramInt1);
//		if (paramInt1 == paramInt2)
//			this.dctRows = this.dctSlices;
//		else
//			this.dctRows = new DoubleDCT_1D(paramInt2);
//		if (paramInt1 == paramInt3)
//			this.dctColumns = this.dctSlices;
//		else if (paramInt2 == paramInt3)
//			this.dctColumns = this.dctRows;
//		else
//			this.dctColumns = new DoubleDCT_1D(paramInt3);
//	}
//
...
//								int j = i * DoubleDCT_3D.this.sliceStride;
//								for (int k = 0; k < DoubleDCT_3D.this.rows; ++k)
//									DoubleDCT_3D.this.dctColumns
//											.forward(
//													this.val$a,
//													j
//															+ k
//															* DoubleDCT_3D.this.rowStride,
//													this.val$scale);
//							}
//						}
//					});
...
//							i2, paramArrayOfDouble, paramBoolean) {
//						public void run() {
//							double[] arrayOfDouble = new double[DoubleDCT_3D.this.rows];
//							for (int i = this.val$firstSlice; i < this.val$lastSlice; ++i) {
//								int j = i * DoubleDCT_3D.this.sliceStride;
//								for (int k = 0; k < DoubleDCT_3D.this.columns; ++k) {
//									int i1;
//									for (int l = 0; l < DoubleDCT_3D.this.rows; ++l) {
//										i1 = j + l
//												* DoubleDCT_3D.this.rowStride
//												+ k;
//										arrayOfDouble[l] = this.val$a[i1];
//									}
//									DoubleDCT_3D.this.dctRows.forward(
//											arrayOfDouble, this.val$scale);
//									for (l = 0; l < DoubleDCT_3D.this.rows; ++l) {
//										i1 = j + l
//												* DoubleDCT_3D.this.rowStride
//												+ k;
...
//							i2, paramArrayOfDouble, paramBoolean) {
//						public void run() {
//							double[] arrayOfDouble = new double[DoubleDCT_3D.this.slices];
//							for (int i = this.val$firstRow; i < this.val$lastRow; ++i) {
//								int j = i * DoubleDCT_3D.this.rowStride;
//								for (int k = 0; k < DoubleDCT_3D.this.columns; ++k) {
//									int i1;
//									for (int l = 0; l < DoubleDCT_3D.this.slices; ++l) {
//										i1 = l * DoubleDCT_3D.this.sliceStride
//												+ j + k;
//										arrayOfDouble[l] = this.val$a[i1];
//									}
//									DoubleDCT_3D.this.dctSlices.forward(
//											arrayOfDouble, this.val$scale);
//									for (l = 0; l < DoubleDCT_3D.this.slices; ++l) {
//										i1 = l * DoubleDCT_3D.this.sliceStride
//												+ j + k;
//										this.val$a[i1] = arrayOfDouble[l];
//									}
...
//						this.dctColumns.forward(paramArrayOfDouble, k + l
...
//							arrayOfDouble[i2] = paramArrayOfDouble[i3];
//						}
//						this.dctSlices.forward(arrayOfDouble, paramBoolean);
//						for (i2 = 0; i2 < this.slices; ++i2) {
//							i3 = i2 * this.sliceStride + l + i1;
//							paramArrayOfDouble[i3] = arrayOfDouble[i2];
//						}
...
//									DoubleDCT_3D.this.dctColumns.forward(
...
//									DoubleDCT_3D.this.dctRows.forward(
//											arrayOfDouble, this.val$scale);
//									for (k = 0; k < DoubleDCT_3D.this.rows; ++k)
...
//							for (int i = this.val$firstRow; i < this.val$lastRow; ++i)
//								for (int j = 0; j < DoubleDCT_3D.this.columns; ++j) {
//									for (int k = 0; k < DoubleDCT_3D.this.slices; ++k)
//										arrayOfDouble[k] = this.val$a[k][i][j];
//									DoubleDCT_3D.this.dctSlices.forward(
//											arrayOfDouble, this.val$scale);
//									for (k = 0; k < DoubleDCT_3D.this.slices; ++k)
...
//				for (int j = 0; j < this.slices; ++j)
//					for (k = 0; k < this.rows; ++k)
//						this.dctColumns.forward(paramArrayOfDouble[j][k],
//								paramBoolean);
//				double[] arrayOfDouble = new double[this.rows];
//				for (k = 0; k < this.slices; ++k)
...
//										arrayOfDouble[l] = this.val$a[i1];
//									}
//									DoubleDCT_3D.this.dctRows.inverse(
//											arrayOfDouble, this.val$scale);
//									for (l = 0; l < DoubleDCT_3D.this.rows; ++l) {
//										i1 = j + l
//												* DoubleDCT_3D.this.rowStride
...
//										arrayOfDouble[l] = this.val$a[i1];
//									}
//									DoubleDCT_3D.this.dctSlices.inverse(
//											arrayOfDouble, this.val$scale);
//									for (l = 0; l < DoubleDCT_3D.this.slices; ++l) {
//										i1 = l * DoubleDCT_3D.this.sliceStride
//												+ j + k;
...
//					k = j * this.sliceStride;
//					for (l = 0; l < this.rows; ++l)
//						this.dctColumns.inverse(paramArrayOfDouble, k + l
//								* this.rowStride, paramBoolean);
//				}
//				double[] arrayOfDouble = new double[this.rows];
//				int i3;
...
//							arrayOfDouble[i2] = paramArrayOfDouble[i3];
//						}
//						this.dctSlices.inverse(arrayOfDouble, paramBoolean);
//						for (i2 = 0; i2 < this.slices; ++i2) {
//							i3 = i2 * this.sliceStride + l + i1;
//							paramArrayOfDouble[i3] = arrayOfDouble[i2];
//						}
...
//							for (int i = this.val$firstSlice; i < this.val$lastSlice; ++i)
//								for (int j = 0; j < DoubleDCT_3D.this.rows; ++j)
//									DoubleDCT_3D.this.dctColumns.inverse(
//											this.val$a[i][j], this.val$scale);
//						}
//					});
//				}
...
//				for (int j = 0; j < this.slices; ++j)
//					for (k = 0; k < this.rows; ++k)
//						this.dctColumns.inverse(paramArrayOfDouble[j][k],
//								paramBoolean);
//				double[] arrayOfDouble = new double[this.rows];
//				for (k = 0; k < this.slices; ++k)
//					for (l = 0; l < this.columns; ++l) {
...
//				for (i1 = 0; i1 < this.rows; ++i1)
//					this.dctColumns.forward(paramArrayOfDouble, i + i1
//							* this.rowStride, paramBoolean);
//				if (this.columns > 2) {
...
//				i = l * this.sliceStride;
//				for (i1 = 0; i1 < this.rows; ++i1)
//					this.dctColumns.inverse(paramArrayOfDouble, i + i1
//							* this.rowStride, paramBoolean);
//				if (this.columns > 2) {
//					for (i1 = 0; i1 < this.columns; i1 += 4) {
//						for (i2 = 0; i2 < this.rows; ++i2) {
...
//					if (this.val$isgn == -1) {
//						l = this.val$n0;
//						while (l < DoubleDCT_3D.this.slices) {
//							i = l * DoubleDCT_3D.this.sliceStride;
//							for (i1 = 0; i1 < DoubleDCT_3D.this.rows; ++i1)
//								DoubleDCT_3D.this.dctColumns.forward(
//										this.val$a, i + i1
//												* DoubleDCT_3D.this.rowStride,
//										this.val$scale);
//							if (DoubleDCT_3D.this.columns > 2) {
//								for (i1 = 0; i1 < DoubleDCT_3D.this.columns; i1 += 4) {
//									for (i2 = 0; i2 < DoubleDCT_3D.this.rows; ++i2) {
//										j = i + i2
//												* DoubleDCT_3D.this.rowStride
//												+ i1;
//										k = this.val$startt
//												+ DoubleDCT_3D.this.rows + i2;
//										DoubleDCT_3D.this.t[(this.val$startt + i2)] = this.val$a[j];
//										DoubleDCT_3D.this.t[k] = this.val$a[(j + 1)];
//										DoubleDCT_3D.this.t[(k + DoubleDCT_3D.this.rows)] = this.val$a[(j + 2)];
//										DoubleDCT_3D.this.t[(k + 2 * DoubleDCT_3D.this.rows)] = this.val$a[(j + 3)];
//									}
//									DoubleDCT_3D.this.dctRows.forward(
//											DoubleDCT_3D.this.t,
...
//										k = this.val$startt
//												+ DoubleDCT_3D.this.rows + i2;
//										this.val$a[j] = DoubleDCT_3D
//												.access$800(DoubleDCT_3D.this)[(this.val$startt + i2)];
//										this.val$a[(j + 1)] = DoubleDCT_3D
//												.access$800(DoubleDCT_3D.this)[k];
//										this.val$a[(j + 2)] = DoubleDCT_3D
//												.access$800(DoubleDCT_3D.this)[(k + DoubleDCT_3D
//												.access$100(DoubleDCT_3D.this))];
//										this.val$a[(j + 3)] = DoubleDCT_3D
//												.access$800(DoubleDCT_3D.this)[(k + 2 * DoubleDCT_3D
//												.access$100(DoubleDCT_3D.this))];
//									}
//								}
//							} else if (DoubleDCT_3D.this.columns == 2) {
//								for (i1 = 0; i1 < DoubleDCT_3D.this.rows; ++i1) {
//									j = i + i1 * DoubleDCT_3D.this.rowStride;
//									DoubleDCT_3D.this.t[(this.val$startt + i1)] = this.val$a[j];
//									DoubleDCT_3D.this.t[(this.val$startt
//											+ DoubleDCT_3D.this.rows + i1)] = this.val$a[(j + 1)];
//								}
//								DoubleDCT_3D.this.dctRows.forward(
//										DoubleDCT_3D.this.t, this.val$startt,
//										this.val$scale);
...
//									j = i + i1 * DoubleDCT_3D.this.rowStride;
//									this.val$a[j] = DoubleDCT_3D
//											.access$800(DoubleDCT_3D.this)[(this.val$startt + i1)];
//									this.val$a[(j + 1)] = DoubleDCT_3D
//											.access$800(DoubleDCT_3D.this)[(this.val$startt
//											+ DoubleDCT_3D
//													.access$100(DoubleDCT_3D.this) + i1)];
//								}
//							}
//							l += this.val$nthreads;
//						}
...
//					if (this.val$isgn == -1) {
//						j = this.val$n0;
//						while (j < DoubleDCT_3D.this.slices) {
//							for (k = 0; k < DoubleDCT_3D.this.rows; ++k)
//								DoubleDCT_3D.this.dctColumns.forward(
//										this.val$a[j][k], this.val$scale);
//							if (DoubleDCT_3D.this.columns > 2) {
//								for (k = 0; k < DoubleDCT_3D.this.columns; k += 4) {
//									for (l = 0; l < DoubleDCT_3D.this.rows; ++l) {
//										i = this.val$startt
//												+ DoubleDCT_3D.this.rows + l;
//										DoubleDCT_3D.this.t[(this.val$startt + l)] = this.val$a[j][l][k];
//										DoubleDCT_3D.this.t[i] = this.val$a[j][l][(k + 1)];
//										DoubleDCT_3D.this.t[(i + DoubleDCT_3D.this.rows)] = this.val$a[j][l][(k + 2)];
//										DoubleDCT_3D.this.t[(i + 2 * DoubleDCT_3D.this.rows)] = this.val$a[j][l][(k + 3)];
//									}
//									DoubleDCT_3D.this.dctRows.forward(
//											DoubleDCT_3D.this.t,
//											this.val$startt, this.val$scale);
...
//										i = this.val$startt
//												+ DoubleDCT_3D.this.rows + l;
//										this.val$a[j][l][k] = DoubleDCT_3D
//												.access$800(DoubleDCT_3D.this)[(this.val$startt + l)];
//										this.val$a[j][l][(k + 1)] = DoubleDCT_3D
//												.access$800(DoubleDCT_3D.this)[i];
//										this.val$a[j][l][(k + 2)] = DoubleDCT_3D
//												.access$800(DoubleDCT_3D.this)[(i + DoubleDCT_3D
//												.access$100(DoubleDCT_3D.this))];
//										this.val$a[j][l][(k + 3)] = DoubleDCT_3D
//												.access$800(DoubleDCT_3D.this)[(i + 2 * DoubleDCT_3D
//												.access$100(DoubleDCT_3D.this))];
//									}
//								}
//							} else if (DoubleDCT_3D.this.columns == 2) {
//								for (k = 0; k < DoubleDCT_3D.this.rows; ++k) {
//									DoubleDCT_3D.this.t[(this.val$startt + k)] = this.val$a[j][k][0];
//									DoubleDCT_3D.this.t[(this.val$startt
//											+ DoubleDCT_3D.this.rows + k)] = this.val$a[j][k][1];
//								}
//								DoubleDCT_3D.this.dctRows.forward(
//										DoubleDCT_3D.this.t, this.val$startt,
//										this.val$scale);
...
//										this.val$scale);
//								for (k = 0; k < DoubleDCT_3D.this.rows; ++k) {
//									this.val$a[j][k][0] = DoubleDCT_3D
//											.access$800(DoubleDCT_3D.this)[(this.val$startt + k)];
//									this.val$a[j][k][1] = DoubleDCT_3D
//											.access$800(DoubleDCT_3D.this)[(this.val$startt
//											+ DoubleDCT_3D
//													.access$100(DoubleDCT_3D.this) + k)];
//								}
//							}
//							j += this.val$nthreads;
//						}
...
//						if (DoubleDCT_3D.this.columns > 2) {
//							l = this.val$n0;
//							while (l < DoubleDCT_3D.this.rows) {
//								i = l * DoubleDCT_3D.this.rowStride;
//								for (i1 = 0; i1 < DoubleDCT_3D.this.columns; i1 += 4) {
//									for (i2 = 0; i2 < DoubleDCT_3D.this.slices; ++i2) {
//										j = i2 * DoubleDCT_3D.this.sliceStride
//												+ i + i1;
//										k = this.val$startt
//												+ DoubleDCT_3D.this.slices + i2;
//										DoubleDCT_3D.this.t[(this.val$startt + i2)] = this.val$a[j];
//										DoubleDCT_3D.this.t[k] = this.val$a[(j + 1)];
//										DoubleDCT_3D.this.t[(k + DoubleDCT_3D.this.slices)] = this.val$a[(j + 2)];
//										DoubleDCT_3D.this.t[(k + 2 * DoubleDCT_3D.this.slices)] = this.val$a[(j + 3)];
//									}
//									DoubleDCT_3D.this.dctSlices.forward(
//											DoubleDCT_3D.this.t,
//											this.val$startt, this.val$scale);
...
//							while (l < DoubleDCT_3D.this.rows) {
//								i = l * DoubleDCT_3D.this.rowStride;
//								for (i1 = 0; i1 < DoubleDCT_3D.this.slices; ++i1) {
//									j = i1 * DoubleDCT_3D.this.sliceStride + i;
//									DoubleDCT_3D.this.t[(this.val$startt + i1)] = this.val$a[j];
//									DoubleDCT_3D.this.t[(this.val$startt
//											+ DoubleDCT_3D.this.slices + i1)] = this.val$a[(j + 1)];
//								}
//								DoubleDCT_3D.this.dctSlices.forward(
//										DoubleDCT_3D.this.t, this.val$startt,
//										this.val$scale);
...
//											.access$800(DoubleDCT_3D.this)[(this.val$startt
//											+ DoubleDCT_3D
//													.access$600(DoubleDCT_3D.this) + i1)];
//								}
//								l += this.val$nthreads;
//							}
//						}
...
//							for (i1 = 0; i1 < DoubleDCT_3D.this.columns; i1 += 4) {
//								for (i2 = 0; i2 < DoubleDCT_3D.this.slices; ++i2) {
//									j = i2 * DoubleDCT_3D.this.sliceStride + i
//											+ i1;
//									k = this.val$startt
//											+ DoubleDCT_3D.this.slices + i2;
//									DoubleDCT_3D.this.t[(this.val$startt + i2)] = this.val$a[j];
...
//								DoubleDCT_3D.this.dctSlices.inverse(
//										DoubleDCT_3D.this.t, this.val$startt
//												+ 2 * DoubleDCT_3D.this.slices,
//										this.val$scale);
//								DoubleDCT_3D.this.dctSlices.inverse(
//										DoubleDCT_3D.this.t, this.val$startt
//												+ 3 * DoubleDCT_3D.this.slices,
//										this.val$scale);
//								for (i2 = 0; i2 < DoubleDCT_3D.this.slices; ++i2) {
//									j = i2 * DoubleDCT_3D.this.sliceStride + i
//											+ i1;
...
//									for (l = 0; l < DoubleDCT_3D.this.slices; ++l) {
//										i = this.val$startt
//												+ DoubleDCT_3D.this.slices + l;
//										DoubleDCT_3D.this.t[(this.val$startt + l)] = this.val$a[l][j][k];
//										DoubleDCT_3D.this.t[i] = this.val$a[l][j][(k + 1)];
//										DoubleDCT_3D.this.t[(i + DoubleDCT_3D.this.slices)] = this.val$a[l][j][(k + 2)];
//										DoubleDCT_3D.this.t[(i + 2 * DoubleDCT_3D.this.slices)] = this.val$a[l][j][(k + 3)];
//									}
//									DoubleDCT_3D.this.dctSlices.forward(
//											DoubleDCT_3D.this.t,
//											this.val$startt, this.val$scale);
...
//										i = this.val$startt
//												+ DoubleDCT_3D.this.slices + l;
//										this.val$a[l][j][k] = DoubleDCT_3D
//												.access$800(DoubleDCT_3D.this)[(this.val$startt + l)];
//										this.val$a[l][j][(k + 1)] = DoubleDCT_3D
//												.access$800(DoubleDCT_3D.this)[i];
//										this.val$a[l][j][(k + 2)] = DoubleDCT_3D
//												.access$800(DoubleDCT_3D.this)[(i + DoubleDCT_3D
//												.access$600(DoubleDCT_3D.this))];
//										this.val$a[l][j][(k + 3)] = DoubleDCT_3D
//												.access$800(DoubleDCT_3D.this)[(i + 2 * DoubleDCT_3D
//												.access$600(DoubleDCT_3D.this))];
//									}
//								}
...
//							while (j < DoubleDCT_3D.this.rows) {
//								for (k = 0; k < DoubleDCT_3D.this.slices; ++k) {
//									DoubleDCT_3D.this.t[(this.val$startt + k)] = this.val$a[k][j][0];
//									DoubleDCT_3D.this.t[(this.val$startt
//											+ DoubleDCT_3D.this.slices + k)] = this.val$a[k][j][1];
//								}
//								DoubleDCT_3D.this.dctSlices.forward(
//										DoubleDCT_3D.this.t, this.val$startt,
//										this.val$scale);
...
//										this.val$scale);
//								for (k = 0; k < DoubleDCT_3D.this.slices; ++k) {
//									this.val$a[k][j][0] = DoubleDCT_3D
//											.access$800(DoubleDCT_3D.this)[(this.val$startt + k)];
//									this.val$a[k][j][1] = DoubleDCT_3D
//											.access$800(DoubleDCT_3D.this)[(this.val$startt
//											+ DoubleDCT_3D
//													.access$600(DoubleDCT_3D.this) + k)];
//								}
//								j += this.val$nthreads;
//							}
//						}
