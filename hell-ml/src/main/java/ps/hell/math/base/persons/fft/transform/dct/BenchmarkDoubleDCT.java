...
//				"benchmarkDoubleForwardDCT_1D.txt", nthread, niter, doWarmup,
...
//		double[] arrayOfDouble1 = new double[nsize];
//		for (int i = 0; i < nsize; ++i) {
//			System.out.println("Forward DCT 2D (input 1D) of size "
//					+ sizes2D[i] + " x " + sizes2D[i]);
//			DoubleDCT_2D localDoubleDCT_2D = new DoubleDCT_2D(sizes2D[i],
//					sizes2D[i]);
...
//		}
//		IOUtils.writeFFTBenchmarkResultsToFile(
//				"benchmarkDoubleForwardDCT_2D_input_1D.txt", nthread, niter,
...
//		for (int i = 0; i < nsize; ++i) {
//			System.out.println("Forward DCT 2D (input 2D) of size "
//					+ sizes2D[i] + " x " + sizes2D[i]);
//			DoubleDCT_2D localDoubleDCT_2D = new DoubleDCT_2D(sizes2D[i],
//					sizes2D[i]);
...
//		double[] arrayOfDouble1 = new double[nsize];
//		for (int i = 0; i < nsize; ++i) {
//			System.out.println("Forward DCT 3D (input 1D) of size "
//					+ sizes3D[i] + " x " + sizes3D[i] + " x " + sizes3D[i]);
//			DoubleDCT_3D localDoubleDCT_3D = new DoubleDCT_3D(sizes3D[i],
//					sizes3D[i], sizes3D[i]);
...
//		double[] arrayOfDouble = new double[nsize];
//		for (int i = 0; i < nsize; ++i) {
//			System.out.println("Forward DCT 3D (input 3D) of size "
//					+ sizes3D[i] + " x " + sizes3D[i] + " x " + sizes3D[i]);
//			DoubleDCT_3D localDoubleDCT_3D = new DoubleDCT_3D(sizes3D[i],
//					sizes3D[i], sizes3D[i]);
...
//		}
//		IOUtils.writeFFTBenchmarkResultsToFile(
//				"benchmarkDoubleForwardDCT_3D_input_3D.txt", nthread, niter,
