...
//			threadsBegin3D = Integer.parseInt(paramArrayOfString[3]);
...
//			float[] arrayOfFloat = new float[2 * sizes1D[i]];
//			if (doWarmup) {
//				IOUtils.fillMatrix_1D(2 * sizes1D[i], arrayOfFloat);
...
//				"benchmarkFloatComplexForwardFFT_1D.txt", nthread, niter,
//				doWarmup, doScaling, sizes1D, arrayOfDouble);
//	}
//
...
//			FloatFFT_2D localFloatFFT_2D = new FloatFFT_2D(sizes2D[i],
//					sizes2D[i]);
//			float[] arrayOfFloat = new float[sizes2D[i] * 2 * sizes2D[i]];
//			if (doWarmup) {
//				IOUtils.fillMatrix_2D(sizes2D[i], 2 * sizes2D[i], arrayOfFloat);
...
//		}
//		IOUtils.writeFFTBenchmarkResultsToFile(
//				"benchmarkFloatComplexForwardFFT_2D_input_1D.txt", nthread,
...
//		}
//		IOUtils.writeFFTBenchmarkResultsToFile(
//				"benchmarkFloatComplexForwardFFT_2D_input_2D.txt", nthread,
//				niter, doWarmup, doScaling, sizes2D, arrayOfDouble);
//	}
//
...
//		}
//		IOUtils.writeFFTBenchmarkResultsToFile(
//				"benchmarkFloatRealForwardFFT_2D_input_1D.txt", nthread, niter,
...
//			FloatFFT_3D localFloatFFT_3D = new FloatFFT_3D(sizes3D[i],
//					sizes3D[i], sizes3D[i]);
//			float[] arrayOfFloat = new float[sizes3D[i] * sizes3D[i] * 2
//					* sizes3D[i]];
//			if (doWarmup) {
...
//		}
//		IOUtils.writeFFTBenchmarkResultsToFile(
//				"benchmarkFloatComplexForwardFFT_3D_input_1D.txt", nthread,
...
//			FloatFFT_3D localFloatFFT_3D = new FloatFFT_3D(sizes3D[i],
//					sizes3D[i], sizes3D[i]);
//			float[][][] arrayOfFloat = new float[sizes3D[i]][sizes3D[i]][2 * sizes3D[i]];
//			if (doWarmup) {
//				IOUtils.fillMatrix_3D(sizes3D[i], sizes3D[i], 2 * sizes3D[i],
//						arrayOfFloat);
//				localFloatFFT_3D.complexForward(arrayOfFloat);
...
//		}
//		IOUtils.writeFFTBenchmarkResultsToFile(
//				"benchmarkFloatComplexForwardFFT_3D_input_3D.txt", nthread,
//				niter, doWarmup, doScaling, sizes3D, arrayOfDouble);
//	}
//
...
//		}
//		IOUtils.writeFFTBenchmarkResultsToFile(
//				"benchmarkFloatRealForwardFFT_3D_input_3D.txt", nthread, niter,
//				doWarmup, doScaling, sizes3D, arrayOfDouble);
//	}
//
