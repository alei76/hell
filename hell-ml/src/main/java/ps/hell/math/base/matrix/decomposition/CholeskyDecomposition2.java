 ...
 * @author Haifeng Li
 */
public class CholeskyDecomposition2 {
     ...
     */
    private CholeskyDecomposition2() {
     ...
     */
    public static CholeskyDecomposition2 newInstance(double[][] L) {
        CholeskyDecomposition2 cholesky = new CholeskyDecomposition2();
        cholesky.L = L;
        return cholesky;
    }
     ...
     */
    public CholeskyDecomposition2(double[][] A) {
        this(A, false);
    }
     ...
     * @throws IllegalArgumentException if the matrix is not positive definite.
     */
    public CholeskyDecomposition2(double[][] A, boolean overwrite) {
        int n = A.length;
        if (n != A[n - 1].length) {
    ...
    public double[][] inverse() {
        double[][] I = MathBase.eye(L.length);
        solve(I);
        return I;
    }
