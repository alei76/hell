...
//				"benchmarkFloatForwardDHT_1D.txt", nthread, niter, doWarmup,
...
//			FloatDHT_2D localFloatDHT_2D = new FloatDHT_2D(sizes2D[i],
//					sizes2D[i]);
...
//		}
//		IOUtils.writeFFTBenchmarkResultsToFile(
//				"benchmarkFloatForwardDHT_2D_input_1D.txt", nthread, niter,
...
//			FloatDHT_3D localFloatDHT_3D = new FloatDHT_3D(sizes3D[i],
//					sizes3D[i], sizes3D[i]);
...
//		}
//		IOUtils.writeFFTBenchmarkResultsToFile(
//				"benchmarkFloatForwardDHT_3D_input_1D.txt", nthread, niter,
...
//		}
//		IOUtils.writeFFTBenchmarkResultsToFile(
//				"benchmarkFloatForwardDHT_3D_input_3D.txt", nthread, niter,
//				doWarmup, doScaling, sizes3D, arrayOfDouble);
//	}
//
