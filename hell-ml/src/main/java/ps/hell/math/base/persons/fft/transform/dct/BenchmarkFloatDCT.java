...
//				"benchmarkFloatForwardDCT_1D.txt", nthread, niter, doWarmup,
...
//			FloatDCT_2D localFloatDCT_2D = new FloatDCT_2D(sizes2D[i],
//					sizes2D[i]);
...
//		}
//		IOUtils.writeFFTBenchmarkResultsToFile(
//				"benchmarkFloatForwardDCT_2D_input_1D.txt", nthread, niter,
...
//		}
//		IOUtils.writeFFTBenchmarkResultsToFile(
//				"benchmarkFloatForwardDCT_2D_input_2D.txt", nthread, niter,
//				doWarmup, doScaling, sizes2D, arrayOfDouble);
//	}
//
...
//			FloatDCT_3D localFloatDCT_3D = new FloatDCT_3D(sizes3D[i],
//					sizes3D[i], sizes3D[i]);
