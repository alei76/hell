 ...
 *******************************************************************************/
package ps.hell.base.data.parse.test;
...
public class SparseMatrixParserTest {
    ...
    public void testParse() throws Exception {
        ...
        try {
            ...
            SparseMatrix data = parser.parse(this.getClass().getResourceAsStream("/smile/data/matrix/08blocks.txt"));
    ...
    public void testParseExchange() throws Exception {
        ...
        try {
            SparseMatrixParser parser = new SparseMatrixParser();
            SparseMatrix data = parser.parse(this.getClass().getResourceAsStream("/smile/data/matrix/5by5_rua.hb"));
