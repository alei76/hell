    ...
    public static void sort(int[] arr, int[] brr, int n) {
        ...
        for (;;) {
            if (ir - l < M) {
                ...
                k = (l + ir) >> 1;
                MathBase.swap(arr, k, l + 1);
                MathBase.swap(brr, k, l + 1);
                if (arr[l] > arr[ir]) {
                    MathBase.swap(arr, l, ir);
                    MathBase.swap(brr, l, ir);
                }
                if (arr[l + 1] > arr[ir]) {
                    MathBase.swap(arr, l + 1, ir);
                    MathBase.swap(brr, l + 1, ir);
                }
                if (arr[l] > arr[l + 1]) {
                    MathBase.swap(arr, l, l + 1);
                    MathBase.swap(brr, l, l + 1);
                }
                i = l + 1;
                j = ir;
                a = arr[l + 1];
                ...
                for (;;) {
                    ...
                    MathBase.swap(arr, i, j);
                    MathBase.swap(brr, i, j);
                }
                arr[l + 1] = arr[j];
                arr[j] = a;
                brr[l + 1] = brr[j];
