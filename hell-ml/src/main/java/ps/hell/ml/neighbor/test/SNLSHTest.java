...
import ps.hell.base.data.parse.IOUtils;
import ps.hell.math.base.distance.HammingDistance;
import ps.hell.ml.neighbor.Neighbor;
import ps.hell.ml.neighbor.SNLSH;
import ps.hell.ml.neighbor.SNLSH.AbstractSentence;
...
import static ps.hell.ml.neighbor.SNLSH.SimHash.simhash64;
...
public class SNLSHTest {
    ...
    private Neighbor<AbstractSentence, AbstractSentence>[] linearKNN(AbstractSentence q, int k) {
