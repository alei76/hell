...
package ps.hell.ml.rs.librec.main;
...
import ps.hell.ml.rs.librec.baseline.ConstantGuess;
import ps.hell.ml.rs.librec.baseline.GlobalAverage;
import ps.hell.ml.rs.librec.baseline.ItemAverage;
import ps.hell.ml.rs.librec.baseline.ItemCluster;
import ps.hell.ml.rs.librec.baseline.MostPopular;
import ps.hell.ml.rs.librec.baseline.RandomGuess;
import ps.hell.ml.rs.librec.baseline.UserAverage;
import ps.hell.ml.rs.librec.baseline.UserCluster;
import ps.hell.ml.rs.librec.data.DataDAO;
import ps.hell.ml.rs.librec.data.DataSplitter;
import ps.hell.ml.rs.librec.data.MatrixEntry;
import ps.hell.ml.rs.librec.data.SparseMatrix;
import ps.hell.ml.rs.librec.ext.AR;
import ps.hell.ml.rs.librec.ext.External;
import ps.hell.ml.rs.librec.ext.Hybrid;
import ps.hell.ml.rs.librec.ext.NMF;
import ps.hell.ml.rs.librec.ext.PD;
import ps.hell.ml.rs.librec.ext.PRankD;
import ps.hell.ml.rs.librec.ext.SlopeOne;
import ps.hell.ml.rs.librec.intf.GraphicRecommender;
import ps.hell.ml.rs.librec.intf.IterativeRecommender;
import ps.hell.ml.rs.librec.intf.Recommender;
import ps.hell.ml.rs.librec.intf.Recommender.Measure;
import ps.hell.ml.rs.librec.ranking.BHfree;
import ps.hell.ml.rs.librec.ranking.BPR;
import ps.hell.ml.rs.librec.ranking.BUCM;
import ps.hell.ml.rs.librec.ranking.CLiMF;
import ps.hell.ml.rs.librec.ranking.FISMauc;
import ps.hell.ml.rs.librec.ranking.FISMrmse;
import ps.hell.ml.rs.librec.ranking.GBPR;
import ps.hell.ml.rs.librec.ranking.ItemBigram;
import ps.hell.ml.rs.librec.ranking.LDA;
import ps.hell.ml.rs.librec.ranking.LRMF;
import ps.hell.ml.rs.librec.ranking.RankALS;
import ps.hell.ml.rs.librec.ranking.RankSGD;
import ps.hell.ml.rs.librec.ranking.SBPR;
import ps.hell.ml.rs.librec.ranking.SLIM;
import ps.hell.ml.rs.librec.ranking.WBPR;
import ps.hell.ml.rs.librec.ranking.WRMF;
import ps.hell.ml.rs.librec.rating.BPMF;
import ps.hell.ml.rs.librec.rating.BiasedMF;
import ps.hell.ml.rs.librec.rating.CPTF;
import ps.hell.ml.rs.librec.rating.GPLSA;
import ps.hell.ml.rs.librec.rating.ItemKNN;
import ps.hell.ml.rs.librec.rating.LDCC;
import ps.hell.ml.rs.librec.rating.PMF;
import ps.hell.ml.rs.librec.rating.RSTE;
import ps.hell.ml.rs.librec.rating.SVDPlusPlus;
import ps.hell.ml.rs.librec.rating.SoRec;
import ps.hell.ml.rs.librec.rating.SoReg;
import ps.hell.ml.rs.librec.rating.SocialMF;
import ps.hell.ml.rs.librec.rating.TimeSVD;
import ps.hell.ml.rs.librec.rating.TrustMF;
import ps.hell.ml.rs.librec.rating.TrustSVD;
import ps.hell.ml.rs.librec.rating.URP;
import ps.hell.ml.rs.librec.rating.UserKNN;
import ps.hell.ml.rs.librec.util.Dates;
import ps.hell.ml.rs.librec.util.EMailer;
import ps.hell.ml.rs.librec.util.FileConfiger;
import ps.hell.ml.rs.librec.util.FileIO;
import ps.hell.ml.rs.librec.util.LineConfiger;
import ps.hell.ml.rs.librec.util.Logs;
import ps.hell.ml.rs.librec.util.Strings;
import ps.hell.ml.rs.librec.util.Systems;
...
public class LibRec {
	...
	protected static String tempDirPath = "./result/ml/rs/data";
	...
	protected void execute(String[] args) throws Exception {
		...
		System.out.println("cmd:"+Arrays.toString(args));
		cmdLine(args);
	...
	protected void cmdLine(String[] args) throws Exception {
		...
		if (args == null || args.length < 1) {
			if (configFiles == null)
				configFiles = Arrays.asList("./ps/hell/ml/rs/librec/main/librec.conf");
			return;
		}
