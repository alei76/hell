...
package ps.hell.ml.feature.select;
...
import ps.hell.ml.gap.FitnessMeasure;
import ps.hell.ml.gap.GeneticAlgorithm;
...
/**
 * 基于遗传算法的特征选择。这种方法发现许多(随机)
*变量的子集的预期使用遗传分类能力
*算法。每个变量的子集的“适应性”是由其决定的
*能力分类根据给定的样本分类
*方法。得到了许多这样的变量子集时,最好
*性能可用作选择特性。另外,频率
*选择变量可能进一步进行分析。最
*经常选择的变量可能是最相关的
*样品的区别,最终用于预测。尽管遗传算法避免了
*蛮力搜索,它仍然比单变量特征选择慢得多
