...
public abstract class RegressionPrior implements Serializable {
    ...
    static class GaussianRegressionPrior
        ...
        public double log2Prior(double beta, int dimension) {
            return -log2Sqrt2Pi
                - 0.5 * ps.hell.ml.nlp.tool.aliasi.util.Math.log2(mValues[dimension])
    ...
    static final double log2Sqrt2Over2 = ps.hell.ml.nlp.tool.aliasi.util.Math.log2(sqrt2/2.0);
    static final double log2Sqrt2Pi
        = ps.hell.ml.nlp.tool.aliasi.util.Math.log2(Math.sqrt(2.0 * Math.PI));
    static final double log21OverPi = -ps.hell.ml.nlp.tool.aliasi.util.Math.log2(Math.PI);
    ...
    static class CauchyRegressionPrior
        ...
        public double log2Prior(double beta, int dimension) {
            return log21OverPi
                + 0.5 * ps.hell.ml.nlp.tool.aliasi.util.Math.log2(mValues[dimension])
                - ps.hell.ml.nlp.tool.aliasi.util.Math.log2(beta * beta + mValues[dimension]
                                            * mValues[dimension]);
        }
        @Override
        public String toString() {
    ...
    static class VariableGaussianRegressionPrior
        ...
        public double log2Prior(double beta, int dimension) {
            ...
            return -log2Sqrt2Pi
                - 0.5 * ps.hell.ml.nlp.tool.aliasi.util.Math.log2(mPriorVariance)
    ...
    static class VariableLaplaceRegressionPrior
        ...
        VariableLaplaceRegressionPrior(double priorVariance,
            ...
            mPriorIntercept
                = log2Sqrt2Over2 - 0.5
                * ps.hell.ml.nlp.tool.aliasi.util.Math.log2(priorVariance);
    ...
    static class VariableCauchyRegressionPrior
        ...
        public double log2Prior(double beta, int dimension) {
            ...
            return log21OverPi
                + 0.5 * ps.hell.ml.nlp.tool.aliasi.util.Math.log2(mPriorVariance)
                - ps.hell.ml.nlp.tool.aliasi.util.Math.log2(beta * beta + mPriorVariance);
        }
        @Override
        public String toString() {
            return toString("CauchyRegressionPrior","Scale");
