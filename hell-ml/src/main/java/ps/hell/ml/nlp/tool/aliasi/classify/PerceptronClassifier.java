...
import ps.hell.ml.nlp.tool.aliasi.matrix.KernelFunction;
...
import ps.hell.ml.nlp.tool.aliasi.util.Arrays;
 ...
 * memory in the form of {@link ps.hell.ml.nlp.tool.aliasi.matrix.SparseFloatVector} and boolean
 ...
 * kernel function {@link ps.hell.ml.nlp.tool.aliasi.matrix.DotProductKernel}.  A good
 * choice for most classification tasks is the polynomial kernel,
 * implemented in {@link ps.hell.ml.nlp.tool.aliasi.matrix.PolynomialKernel}.
 ...
 * {@link ps.hell.ml.nlp.tool.aliasi.matrix.GaussianRadialBasisKernel} works well.
 *
 ...
 * {@link ps.hell.ml.nlp.tool.aliasi.matrix.SparseFloatVector}.
 *
