 ...
 * </copyright>
 */
package ps.hell.ml.nlp.tool.hanlp.hankcs.hanlp.dictionary.nr;

import ps.hell.ml.nlp.tool.hanlp.hankcs.hanlp.HanLP;
import ps.hell.ml.nlp.tool.hanlp.hankcs.hanlp.collection.AhoCorasick.AhoCorasickDoubleArrayTrie;
import ps.hell.ml.nlp.tool.hanlp.hankcs.hanlp.corpus.dictionary.item.EnumItem;
import ps.hell.ml.nlp.tool.hanlp.hankcs.hanlp.corpus.tag.NR;
import ps.hell.ml.nlp.tool.hanlp.hankcs.hanlp.corpus.tag.Nature;
import ps.hell.ml.nlp.tool.hanlp.hankcs.hanlp.dictionary.CoreDictionary;
import ps.hell.ml.nlp.tool.hanlp.hankcs.hanlp.dictionary.TransformMatrixDictionary;
import ps.hell.ml.nlp.tool.hanlp.hankcs.hanlp.seg.common.Vertex;
import ps.hell.ml.nlp.tool.hanlp.hankcs.hanlp.seg.common.WordNet;
...
import static ps.hell.ml.nlp.tool.hanlp.hankcs.hanlp.corpus.tag.NR.*;
import static ps.hell.ml.nlp.tool.hanlp.hankcs.hanlp.corpus.tag.NR.B;
import static ps.hell.ml.nlp.tool.hanlp.hankcs.hanlp.dictionary.nr.NRConstant.*;
import static ps.hell.ml.nlp.tool.hanlp.hankcs.hanlp.dictionary.nr.NRConstant.WORD_ID;
