...
public class BinomialDistribution extends AbstractDiscreteDistribution {
    ...
    public static double log2BinomialCoefficient(long n, long m) {
        ...
        return ps.hell.ml.nlp.tool.aliasi.util.Math.log2Factorial(n)
            - ps.hell.ml.nlp.tool.aliasi.util.Math.log2Factorial(m)
            - ps.hell.ml.nlp.tool.aliasi.util.Math.log2Factorial(n-m);
    }
