...
package ps.hell.ml.nlp.tool.aliasi.chunk;

import ps.hell.ml.nlp.tool.aliasi.hmm.HmmDecoder;
import ps.hell.ml.nlp.tool.aliasi.symbol.SymbolTable;
import ps.hell.ml.nlp.tool.aliasi.tag.ScoredTagging;
...
import static ps.hell.ml.nlp.tool.aliasi.util.Math.naturalLogToBase2Log;
 ...
 * ps.hell.ml.nlp.tool.aliasi.hmm.HmmCharLmEstimator} to estimate the HMM.  This
...
public class HmmChunker implements NBestChunker, ConfidenceChunker {
    ...
    private static class NBestChunkIt extends Iterators.Buffered<Chunk> {
        ...
        NBestChunkIt(TagLattice<String> lattice, String[] whites, int maxNBest) {
            mTotal = ps.hell.ml.nlp.tool.aliasi.util.Math.naturalLogToBase2Log(lattice.logZ());
            mLattice = lattice;
            mWhites = whites;
