...
import ps.hell.ml.nlp.tool.aliasi.stats.MultinomialDistribution;
import ps.hell.ml.nlp.tool.aliasi.stats.MultivariateConstant;
...
public class MultinomialDistributionTest  {
    ...
    public void testOne() {
        ...
        double log2Prob = log2Coeff + 3.0 * ps.hell.ml.nlp.tool.aliasi.util.Math.log2(1.0/6.0)
            + 2.0 * ps.hell.ml.nlp.tool.aliasi.util.Math.log2(2.0/6.0)
            + 1.0 * ps.hell.ml.nlp.tool.aliasi.util.Math.log2(3.0/6.0);
    ...
    public void testCoeff() {
        ...
        counts = new int[] { 1, 1 };
        assertEquals(ps.hell.ml.nlp.tool.aliasi.util.Math.log2(2),
                     MultinomialDistribution
                     .log2MultinomialCoefficient(counts), 0.0001);

        counts = new int[] { 2, 0 };
        assertEquals(ps.hell.ml.nlp.tool.aliasi.util.Math.log2(1),
                     MultinomialDistribution
                     .log2MultinomialCoefficient(counts), 0.0001);

        counts = new int[] { 5, 5, 5 };
        assertEquals(ps.hell.ml.nlp.tool.aliasi.util.Math.log2Factorial(15)
                     - 3.0 * ps.hell.ml.nlp.tool.aliasi.util.Math.log2Factorial(5),
                     MultinomialDistribution
                     .log2MultinomialCoefficient(counts), 0.0001);
