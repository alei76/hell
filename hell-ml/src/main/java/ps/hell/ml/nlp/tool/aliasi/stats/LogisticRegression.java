...
import ps.hell.ml.nlp.tool.aliasi.util.Compilable;
 ...
 * ps.hell.ml.nlp.tool.aliasi.classify.LogisticRegressionClassifier} which adapts this
 * class's models and estimators to act as generic classifiers given
 * an instance of {@link ps.hell.ml.nlp.tool.aliasi.util.FeatureExtractor}.
 *
 *
...
public class LogisticRegression
    ...
    public static LogisticRegression
        ...
        int numOutcomesMinus1 = ps.hell.ml.nlp.tool.aliasi.util.Math.max(cs);
        ...
        for (int epoch = 0; epoch < maxEpochs; ++epoch) {
            ...
            if (!acceptUpdate) {
                ...
                double relativeAbsDiff
                    = ps.hell.ml.nlp.tool.aliasi.util.Math
    ...
    public static double log2Likelihood(Vector[] inputs, int[] cats, LogisticRegression regression) {
        ...
        for (int j = 0; j < numTrainingInstances; ++j) {
            ...
            log2Likelihood += ps.hell.ml.nlp.tool.aliasi.util.Math.log2(conditionalProbs[cats[j]]);
        }
