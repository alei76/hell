...
package ps.hell.ml.nlp.tool.aliasi.test.unit;
...
public class Asserts {
     ...
     * is an instance of {@link Comparable} then its comparison result
     ...
     * not equal according to the comparables {@link Comparable#compareTo} method.
