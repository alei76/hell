...
package ps.hell.ml.nlp.tool.aliasi.hmm;

import ps.hell.ml.nlp.tool.aliasi.symbol.SymbolTable;
import ps.hell.ml.nlp.tool.aliasi.tag.TagLattice;
import ps.hell.ml.nlp.tool.aliasi.util.ScoredObject;
...
class TagWordLattice extends TagLattice<String> {
    ...
    public List<ScoredObject<String>> log2ConditionalTagList(int tokenIndex) {
        ...
        for (int tagId = 0; tagId < numTags; ++tagId) {
            ...
            if (condLog2P > 0.0)
                ...
                condLog2P = ps.hell.ml.nlp.tool.aliasi.util.Math.log2(Double.MIN_VALUE);
    ...
    public double log2Start(int tagId) {
        return ps.hell.ml.nlp.tool.aliasi.util.Math.log2(start(tagId));
    }
    ...
    public double log2End(int tagId) {
        return ps.hell.ml.nlp.tool.aliasi.util.Math.log2(end(tagId));
    }
    ...
    public double log2Transitions(int tokenIndex,
                                  int sourceTagId, int targetTagId) {
        return ps.hell.ml.nlp.tool.aliasi.util.Math.log2(transition(tokenIndex,
    ...
    public double log2Forward(int tokenIndex, int tagId) {
        return ps.hell.ml.nlp.tool.aliasi.util.Math.log2(mForwards[tokenIndex][tagId])
    ...
    public double log2Backward(int tokenIndex, int tagId) {
        return ps.hell.ml.nlp.tool.aliasi.util.Math.log2(mBacks[tokenIndex][tagId])
    ...
    public double logForward(int token, int tag) {
        return ps.hell.ml.nlp.tool.aliasi.util.Math.logBase2ToNaturalLog(log2Forward(token,tag));
    }

    public double logBackward(int token, int tag) {
        return ps.hell.ml.nlp.tool.aliasi.util.Math.logBase2ToNaturalLog(log2Backward(token,tag));
    }


    public double logZ() {
        return ps.hell.ml.nlp.tool.aliasi.util.Math.logBase2ToNaturalLog(log2Total());
    }

    public double logTransition(int tokenFrom, int tagFrom, int tagTo) {
        return ps.hell.ml.nlp.tool.aliasi.util.Math.logBase2ToNaturalLog(log2Transitions(tokenFrom+1,tagFrom,tagTo));
    }

    public double logProbability(int tokenIndex, int tagId) {
        return ps.hell.ml.nlp.tool.aliasi.util.Math.logBase2ToNaturalLog(log2ForwardBackward(tokenIndex,tagId));
    }
    ...
    private void computeTotal() {
        ...
        mLog2Total = ps.hell.ml.nlp.tool.aliasi.util.Math.log2(total)
            + exp;
