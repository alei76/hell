package ps.hell.ml.nlp.tool.aliasi.test.unit.cluster;

import ps.hell.ml.nlp.tool.aliasi.cluster.Dendrogram;
import ps.hell.ml.nlp.tool.aliasi.cluster.LeafDendrogram;
import ps.hell.ml.nlp.tool.aliasi.cluster.LinkDendrogram;
import ps.hell.ml.nlp.tool.aliasi.util.SmallSet;
import org.junit.Test;

import java.util.HashSet;
import java.util.Set;

import static ps.hell.ml.nlp.tool.aliasi.test.unit.Asserts.assertNotEquals;
import static ps.hell.ml.nlp.tool.aliasi.util.CollectionUtils.asSet;
