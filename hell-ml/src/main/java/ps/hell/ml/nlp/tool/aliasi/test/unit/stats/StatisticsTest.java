...
import ps.hell.ml.nlp.tool.aliasi.stats.Statistics;
...
public class StatisticsTest  {
	...
	double expectedKl = 0.4 * ps.hell.ml.nlp.tool.aliasi.util.Math.log2(0.4/0.6)
	    + 0.6 * ps.hell.ml.nlp.tool.aliasi.util.Math.log2(0.6/0.4);
	...
	double expectedJs = 0.4 * ps.hell.ml.nlp.tool.aliasi.util.Math.log2(0.4/0.5)
	    + 0.6 * ps.hell.ml.nlp.tool.aliasi.util.Math.log2(0.6/0.5);
    ...
    public void testNormalizeOK() {
        assertEquals(1.0,
                     ps.hell.ml.nlp.tool.aliasi.util.Math.sum(Statistics.normalize(new double[] { 0, 1, 2, 3 })),
                     0.0001);
        assertEquals(1.0,
    ...
    public void testDirichlet() {
        ...
        assertDirichlet(new double[] { 2.0, 2.0 },
                        new double[] { 0.5, 0.5 },
                        1.5);
        double log2Expected = ps.hell.ml.nlp.tool.aliasi.util.Math.log2Gamma(2 + 2)
            - 2 * ps.hell.ml.nlp.tool.aliasi.util.Math.log2Gamma(2)
            + ps.hell.ml.nlp.tool.aliasi.util.Math.log2(0.25)
            + ps.hell.ml.nlp.tool.aliasi.util.Math.log2(0.75);
        assertDirichlet(2,
                        new double[] { 0.25, 0.75 },
                        Math.pow(2.0,log2Expected));


        double log2Expected2 = ps.hell.ml.nlp.tool.aliasi.util.Math.log2Gamma(3 + 4 + 5)
            - ps.hell.ml.nlp.tool.aliasi.util.Math.log2Gamma(3)
            - ps.hell.ml.nlp.tool.aliasi.util.Math.log2Gamma(4)
            - ps.hell.ml.nlp.tool.aliasi.util.Math.log2Gamma(5)
            + ps.hell.ml.nlp.tool.aliasi.util.Math.log2(Math.pow(0.2,3-1))
            + ps.hell.ml.nlp.tool.aliasi.util.Math.log2(Math.pow(0.3,4-1))
            + ps.hell.ml.nlp.tool.aliasi.util.Math.log2(Math.pow(0.5,5-1));
    ...
    void assertDirichlet(double alpha, double[] xs, double expectedP) {
        double expectedLog2P = ps.hell.ml.nlp.tool.aliasi.util.Math.log2(expectedP);
