...
import ps.hell.ml.nlp.tool.hanlp.hankcs.hanlp.corpus.dictionary.DictionaryMaker;
import ps.hell.ml.nlp.tool.hanlp.hankcs.hanlp.corpus.dictionary.SimpleDictionary;
import ps.hell.ml.nlp.tool.hanlp.hankcs.hanlp.corpus.dictionary.StringDictionary;
import ps.hell.ml.nlp.tool.hanlp.hankcs.hanlp.corpus.dictionary.item.Item;
import ps.hell.ml.nlp.tool.hanlp.hankcs.hanlp.corpus.io.IOUtil;
import ps.hell.ml.nlp.tool.hanlp.hankcs.hanlp.corpus.tag.Nature;
import ps.hell.ml.nlp.tool.hanlp.hankcs.hanlp.dictionary.BiGramDictionary;
...
import ps.hell.ml.nlp.tool.hanlp.hankcs.hanlp.dictionary.py.TonePinyinString2PinyinConverter;
import ps.hell.ml.nlp.tool.hanlp.hankcs.hanlp.dictionary.ts.TraditionalChineseDictionary;
import ps.hell.ml.nlp.tool.hanlp.hankcs.hanlp.seg.NShort.NShortSegment;
