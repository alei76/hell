...
import ps.hell.ml.nlp.tool.aliasi.util.Pair;
...
public class ConditionalClassification extends ScoredClassification {
    ...
    public static ConditionalClassification
        ...
        if (ps.hell.ml.nlp.tool.aliasi.util.Math.sum(probabilityRatios) == 0.0) {
        ...
        for (int i = 0; i < probabilityRatios.length; ++i)
            logProbs[i] = ps.hell.ml.nlp.tool.aliasi.util.Math.log2(probabilityRatios[i]);
    ...
    static double[] logJointToConditional(double[] logJointProbs) {
        ...
        double max = ps.hell.ml.nlp.tool.aliasi.util.Math.maximum(logJointProbs);
        ...
        return ps.hell.ml.nlp.tool.aliasi.stats.Statistics.normalize(probRatios);
    }
