package ps.hell.ml.nlp.tool.aliasi.test.unit.dca;

import ps.hell.ml.nlp.tool.aliasi.dca.DiscreteChooser;
...
import static ps.hell.ml.nlp.tool.aliasi.test.unit.Asserts.assertEqualsArray;
...
public class DiscreteChooserTest {
    ...
    void assertChoice(Vector coeffVector,
        ...
        assertEquals(ps.hell.ml.nlp.tool.aliasi.util.Math.sum(choiceProbs), 1.0, 0.001);
