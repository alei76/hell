...
public class BernoulliClassifier<E>
    ...
    public JointClassification classify(E input) {
        ...
        for (long i = 0; i < numCategories; ++i) {
            ...
            double log2P =ps.hell.ml.nlp.tool.aliasi.util.Math.log2(mCategoryDistribution.probability(i));
            ...
            for (String activeFeature : activeFeatures) {
                ...
                log2P += ps.hell.ml.nlp.tool.aliasi.util.Math.log2((featureCount+1.0) / (categoryCount+2.0));
            }
            ...
            for (String inactiveFeature : inactiveFeatures) {
                ...
                log2P += ps.hell.ml.nlp.tool.aliasi.util.Math.log2((notFeatureCount + 1.0) / (categoryCount + 2.0));
            }
