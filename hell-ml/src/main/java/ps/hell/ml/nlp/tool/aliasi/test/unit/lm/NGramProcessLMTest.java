...
public class NGramProcessLMTest  {
    ...
    public void testA()
        ...
        assertEquals(ps.hell.ml.nlp.tool.aliasi.util.Math.log2(expectedLambda*1.0
    ...
    public void testA_AB() {
        ...
        double expectedCondA
            ...
            + (1.0-expectedLambda)*1.0/128.0;
        assertEquals(ps.hell.ml.nlp.tool.aliasi.util.Math.log2(expectedCondA),
                     model.log2ConditionalEstimate("a"),
                     0.0005);
        double expectedCondB
            = expectedLambda*1.0/3.0
            + (1.0-expectedLambda)*1.0/128.0;
        assertEquals(ps.hell.ml.nlp.tool.aliasi.util.Math.log2(expectedCondB),
        ...
        assertEquals(ps.hell.ml.nlp.tool.aliasi.util.Math.log2(expectedCondAB),
    ...
    public void assertConditionalLM(LanguageModel.Conditional model)
        ...
        assertEquals(ps.hell.ml.nlp.tool.aliasi.util.Math.log2(estimateA),
        ...
        assertEquals(ps.hell.ml.nlp.tool.aliasi.util.Math.log2(estimateB),
                     model.log2ConditionalEstimate(B,0,1),
                     0.0005);

        assertEquals("AB",
                     ps.hell.ml.nlp.tool.aliasi.util.Math.log2(estimateAB),
        ...
        assertEquals("DAB",
                     ps.hell.ml.nlp.tool.aliasi.util.Math.log2(estimateDAB),
                     model.log2ConditionalEstimate(DAB,0,3),
                     0.00005);

        assertEquals(ps.hell.ml.nlp.tool.aliasi.util.Math.log2(estimateDAB),
