...
import ps.hell.ml.nlp.tool.aliasi.util.Proximity;
 ...
 * <code>MARHTA</code>.  Here the match distance is <code>max(6,6)/2 -
 * 1 = 6/2 - 1 = 2</code>, allowing matching characters to be up to one
