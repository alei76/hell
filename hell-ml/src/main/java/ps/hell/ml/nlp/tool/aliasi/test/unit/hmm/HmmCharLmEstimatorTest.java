package ps.hell.ml.nlp.tool.aliasi.test.unit.hmm;

import ps.hell.ml.nlp.tool.aliasi.hmm.HiddenMarkovModel;
import ps.hell.ml.nlp.tool.aliasi.hmm.HmmCharLmEstimator;
...
public class HmmCharLmEstimatorTest  {
    ...
    public void testStart() throws IOException, ClassNotFoundException {
        ...
        assertEquals(ps.hell.ml.nlp.tool.aliasi.util.Math.log2(est.startProb("a")),
                     est.startLog2Prob("a"),0.0001);
        assertEquals(ps.hell.ml.nlp.tool.aliasi.util.Math.log2(est.startProb("b")),
        ...
        assertEquals(ps.hell.ml.nlp.tool.aliasi.util.Math.log2(est2.startProb("a")),
                     est2.startLog2Prob("a"),0.0001);
        assertEquals(ps.hell.ml.nlp.tool.aliasi.util.Math.log2(est2.startProb("b")),
    ...
    public void testEnd() throws IOException, ClassNotFoundException {
        ...
        assertEquals(ps.hell.ml.nlp.tool.aliasi.util.Math.log2(est.endProb("a")),
                     est.endLog2Prob("a"),0.0001);
        assertEquals(ps.hell.ml.nlp.tool.aliasi.util.Math.log2(est.endProb("b")),
        ...
        assertEquals(ps.hell.ml.nlp.tool.aliasi.util.Math.log2(est2.endProb("a")),
                     est2.endLog2Prob("a"),0.0001);
        assertEquals(ps.hell.ml.nlp.tool.aliasi.util.Math.log2(est2.endProb("b")),
    ...
    public void testTransitions2() throws IOException, ClassNotFoundException {
        ...
        assertEquals(est.transitLog2Prob("A","B"),
                     ps.hell.ml.nlp.tool.aliasi.util.Math.log2(est.transitProb("A","B")),
                     0.0001);

        assertEquals(est2.transitLog2Prob("A","B"),
                     ps.hell.ml.nlp.tool.aliasi.util.Math.log2(est2.transitProb("A","B")),
                     0.0001);
    ...
    public void testEmissions() throws IOException, ClassNotFoundException {
        ...
        assertEquals(ps.hell.ml.nlp.tool.aliasi.util.Math.log2(est.emitProb("V","liked")),
        ...
        assertEquals(ps.hell.ml.nlp.tool.aliasi.util.Math.log2(est2.emitProb("V","liked")),
