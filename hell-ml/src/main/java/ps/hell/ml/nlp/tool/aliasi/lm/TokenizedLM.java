...
public class TokenizedLM
    ...
    public double tokenLog2Probability(String[] tokens, int start, int end) {
        ...
        for (int i = start; i < end; ++i) {
            ...
            if (Double.isInfinite(conditionalLog2TokenEstimate)) {
                ...
                log2Estimate
                    +=  ps.hell.ml.nlp.tool.aliasi.util.Math.log2(extCountD
    ...
    private double conditionalLog2TokenEstimate(int[] tokIds,
        ...
        return ps.hell.ml.nlp.tool.aliasi.util.Math.log2(estimate);
    }
        ...
        public void writeExternal(ObjectOutput objOut) throws IOException {
            ...
            objOut.writeFloat((float)
                    ps.hell.ml.nlp.tool.aliasi.util.Math
                              .log2(1.0-mLM.lambda(ps.hell.ml.nlp.tool.aliasi.util.Arrays
                                                   .EMPTY_INT_ARRAY)));
            ...
            int[] outcomes
                ...
                .integersFollowing(ps.hell.ml.nlp.tool.aliasi.util.Arrays.EMPTY_INT_ARRAY,0,0);
            ...
            for (int i = 1; !queue.isEmpty(); ++i) {
                ...
                if (i <= lastInternalNodeIndex) {
                    objOut.writeFloat((float)
                            ps.hell.ml.nlp.tool.aliasi.util.Math.log2(1.0-mLM.lambda(is)));
