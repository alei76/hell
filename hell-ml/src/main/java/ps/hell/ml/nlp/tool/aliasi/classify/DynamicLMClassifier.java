...
import ps.hell.ml.nlp.tool.aliasi.lm.NGramBoundaryLM;
...
import ps.hell.ml.nlp.tool.aliasi.stats.MultivariateEstimator;
...
public class DynamicLMClassifier<L extends LanguageModel.Dynamic>
     ...
     * smoothing.
     *
     * @param categories Categories used for classification.输入的分类类型
     * @param languageModels Dynamic language models for categories. 基础语言模型
     ...
     *
     * @param categories Categories used for classification. 对应的分类的文件夹名儒 neg 和pos
