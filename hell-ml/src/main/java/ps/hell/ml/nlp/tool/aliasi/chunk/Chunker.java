 ...
 * {@link ps.hell.ml.nlp.tool.aliasi.corpus.Parser} that extends {@link
 * ps.hell.ml.nlp.tool.aliasi.corpus.StringParser} by implementing its {@link
 * ps.hell.ml.nlp.tool.aliasi.corpus.StringParser#parseString(char[],int,int)} method using
