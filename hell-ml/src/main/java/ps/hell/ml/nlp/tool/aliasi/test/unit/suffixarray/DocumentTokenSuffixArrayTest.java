package ps.hell.ml.nlp.tool.aliasi.test.unit.suffixarray;

import ps.hell.ml.nlp.tool.aliasi.suffixarray.DocumentTokenSuffixArray;
import ps.hell.ml.nlp.tool.aliasi.suffixarray.TokenSuffixArray;
import ps.hell.ml.nlp.tool.aliasi.tokenizer.IndoEuropeanTokenizerFactory;
import ps.hell.ml.nlp.tool.aliasi.tokenizer.Tokenization;
import ps.hell.ml.nlp.tool.aliasi.tokenizer.TokenizerFactory;
import ps.hell.ml.nlp.tool.aliasi.util.CollectionUtils;
...
import static ps.hell.ml.nlp.tool.aliasi.suffixarray.DocumentTokenSuffixArray.largestWithoutGoingOver;
