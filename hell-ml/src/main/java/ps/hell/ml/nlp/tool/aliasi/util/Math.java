...
package ps.hell.ml.nlp.tool.aliasi.util;
...
public class Math {
     ...
     */
    public static final double LOG2_E = ps.hell.ml.nlp.tool.aliasi.util.Math.log2(java.lang.Math.E);
    ...
    public static double log2Gamma(double z) {
        if (z < 0.5) {
            return ps.hell.ml.nlp.tool.aliasi.util.Math.log2(java.lang.Math.PI)
                - ps.hell.ml.nlp.tool.aliasi.util.Math.log2(java.lang.Math.sin(java.lang.Math.PI * z))
                - log2Gamma(1.0 - z);
        }
        double result = 0.0;
        while (z > 1.5) {
            result += ps.hell.ml.nlp.tool.aliasi.util.Math.log2(z - 1);
            z -= 1.0;
        }
        return result + ps.hell.ml.nlp.tool.aliasi.util.Math.log2(lanczosGamma(z));
    }
