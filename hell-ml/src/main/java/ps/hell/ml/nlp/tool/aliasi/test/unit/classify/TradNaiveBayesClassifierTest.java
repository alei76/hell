...
public class TradNaiveBayesClassifierTest {
    ...
    public void log2CaseProbTest() {
        ...
        assertEquals(ps.hell.ml.nlp.tool.aliasi.util.Math.log2(classifier.probCat("a") * classifier.probToken("mary","a") * classifier.probToken("jumped","a")
                                               + classifier.probCat("b") * classifier.probToken("mary","b") * classifier.probToken("jumped","b")),
                     classifier.log2CaseProb("mary jumped"),
                     0.001);
        assertEquals(ps.hell.ml.nlp.tool.aliasi.util.Math.log2(classifier.probCat("a") + classifier.probCat("b")), // should be 1.0
    ...
    */
    ...
    public void testLengthNorm() throws IOException, ClassNotFoundException {
        ...
        double jointA = 3.0/7.0 * Math.pow(3.0/10.0,10.0);
        double jointB = 4.0/7.0 * Math.pow(1.0/15.0,10.0);
        ...
        jointA = 3.0/7.0 * Math.pow(3.0/10.0 * 2.0/10.0,10.0/2.0);
        jointB = 4.0/7.0 * Math.pow(1.0/15.0 * 2.0/10.0,10.0/2.0);
    ...
    public void testLengthNormTernary() throws IOException, ClassNotFoundException {
        ...
        jointA = 3.0/9.0 * Math.pow(2.0/11.0, 10.0/1.0);
        jointB = 4.0/9.0 * Math.pow(2.0/16.0, 10.0/1.0);
        jointC = 2.0/9.0 * Math.pow(2.0/9.0, 10.0/1.0);
        ...
        jointA = 3.0/9.0 * Math.pow((1.0/11.0) * (1.0/11.0), 10.0/2.0);
        jointB = 4.0/9.0 * Math.pow((1.0/16.0) * (4.0/16.0), 10.0/2.0);
        jointC = 2.0/9.0 * Math.pow((2.0/9.0) * (1.0/9.0), 10.0/2.0);
