...
import ps.hell.ml.nlp.tool.aliasi.lm.CompiledTokenizedLM;
import ps.hell.ml.nlp.tool.aliasi.lm.TokenizedLM;
import ps.hell.ml.nlp.tool.aliasi.lm.TrieIntSeqCounter;
...
public class TokenizedLMTest  {
    ...
    public void testConstantSubModels() throws ClassNotFoundException, IOException {
        ...
        assertEstimate(ps.hell.ml.nlp.tool.aliasi.util.Math.log2(p_EOS * pws_),
                       lm,"");
        ...
        assertEstimate(ps.hell.ml.nlp.tool.aliasi.util.Math.log2(p_UNK * p_EOS 
                                                 * ptok_a 
                                                 * pws_ * pws_),
                       lm,"a");
        ...
        assertEstimate(ps.hell.ml.nlp.tool.aliasi.util.Math.log2(p_UNK * p_UNK * p_EOS
                                                 * pws_ * pws_ * pws_s
                                                 * ptok_a * ptok_b),
                       lm,"a b");

        double ptok_c = ptok_b;
        assertEstimate(ps.hell.ml.nlp.tool.aliasi.util.Math.log2(p_UNK * p_UNK * p_UNK * p_EOS
                                                 * pws_ * pws_ * pws_s * pws_s
                                                 * ptok_a * ptok_b * ptok_c),
                       lm,"a b c");

        double ptok_d = ptok_b;
        assertEstimate(ps.hell.ml.nlp.tool.aliasi.util.Math.log2(p_UNK * p_UNK * p_UNK * p_UNK * p_EOS
        ...
        assertEstimate(ps.hell.ml.nlp.tool.aliasi.util.Math.log2(p_EOS_giv_EOS * pws_),
                       lm,"");
        ...
        assertEstimate(ps.hell.ml.nlp.tool.aliasi.util.Math.log2(p_A_giv_EOS
                                                 * p_EOS_giv_EOS_A
                                                 * pws_ * pws_),
                       lm,"a");
    }
