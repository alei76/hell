 ...
 * </copyright>
 */
package ps.hell.ml.nlp.tool.hanlp.hankcs.hanlp;
...
import ps.hell.ml.nlp.tool.hanlp.hankcs.hanlp.dictionary.ts.SimplifiedChineseDictionary;
import ps.hell.ml.nlp.tool.hanlp.hankcs.hanlp.dictionary.ts.TraditionalChineseDictionary;
import ps.hell.ml.nlp.tool.hanlp.hankcs.hanlp.phrase.IPhraseExtractor;
import ps.hell.ml.nlp.tool.hanlp.hankcs.hanlp.phrase.MutualInformationEntropyPhraseExtractor;
import ps.hell.ml.nlp.tool.hanlp.hankcs.hanlp.seg.Segment;
import ps.hell.ml.nlp.tool.hanlp.hankcs.hanlp.seg.Viterbi.ViterbiSegment;
import ps.hell.ml.nlp.tool.hanlp.hankcs.hanlp.seg.common.Term;
import ps.hell.ml.nlp.tool.hanlp.hankcs.hanlp.summary.TextRankKeyword;
import ps.hell.ml.nlp.tool.hanlp.hankcs.hanlp.summary.TextRankSentence;
...
import static ps.hell.ml.nlp.tool.hanlp.hankcs.hanlp.utility.Predefine.logger;
...
public class HanLP
{
    ...
    public static final class Config
    {
         ...
         * 核心词典路径
         */
        public static String CoreDictionaryPath = "./config/dataset/Text/hanlp/dictionary/CoreNatureDictionary.txt";
        /**
         * 核心词典词性转移矩阵路径
         */
        public static String CoreDictionaryTransformMatrixDictionaryPath = "./config/dataset/Text/hanlp/dictionary/CoreNatureDictionary.tr.txt";
        /**
         * 用户自定义词典路径
         */
        public static String CustomDictionaryPath[] = new String[]{"./config/dataset/Text/hanlp/dictionary/custom/CustomDictionary.txt"};
        /**
         * 2元语法词典路径
         */
        public static String BiGramDictionaryPath = "./config/dataset/Text/hanlp/dictionary/CoreNatureDictionary.ngram.txt";

        /**
         * 停用词词典路径
         */
        public static String CoreStopWordDictionaryPath = "./config/dataset/Text/hanlp/dictionary/stopwords.txt";
        /**
         * 同义词词典路径
         */
        public static String CoreSynonymDictionaryDictionaryPath = "./config/dataset/Text/hanlp/dictionary/synonym/CoreSynonym.txt";
        /**
         * 人名词典路径
         */
        public static String PersonDictionaryPath = "./config/dataset/Text/hanlp/dictionary/person/nr.txt";
        /**
         * 人名词典转移矩阵路径
         */
        public static String PersonDictionaryTrPath = "./config/dataset/Text/hanlp/dictionary/person/nr.tr.txt";
        /**
         * 地名词典路径
         */
        public static String PlaceDictionaryPath = "./config/dataset/Text/hanlp/dictionary/place/ns.txt";
        /**
         * 地名词典转移矩阵路径
         */
        public static String PlaceDictionaryTrPath = "./config/dataset/Text/hanlp/dictionary/place/ns.tr.txt";
        /**
         * 地名词典路径
         */
        public static String OrganizationDictionaryPath = "./config/dataset/Text/hanlp/dictionary/organization/nt.txt";
        /**
         * 地名词典转移矩阵路径
         */
        public static String OrganizationDictionaryTrPath = "./config/dataset/Text/hanlp/dictionary/organization/nt.tr.txt";
        /**
         * 繁简词典路径
         */
        public static String TraditionalChineseDictionaryPath = "./config/dataset/Text/hanlp/dictionary/tc/TraditionalChinese.txt";
        /**
         * 声母韵母语调词典
         */
        public static String SYTDictionaryPath = "./config/dataset/Text/hanlp/dictionary/pinyin/SYTDictionary.txt";

        /**
         * 拼音词典路径
         */
        public static String PinyinDictionaryPath = "./config/dataset/Text/hanlp/dictionary/pinyin/pinyin.txt";

        /**
         * 音译人名词典
         */
        public static String TranslatedPersonDictionaryPath = "./config/dataset/Text/hanlp/dictionary/person/nrf.txt";

        /**
         * 日本人名词典路径
         */
        public static String JapanesePersonDictionaryPath = "./config/dataset/Text/hanlp/dictionary/person/nrj.txt";

        /**
         * 字符类型对应表
         */
        public static String CharTypePath = "./config/dataset/Text/hanlp/dictionary/other/CharType.dat.yes";

        /**
         * 字符正规化表（全角转半角，繁体转简体）
         */
        public static String CharTablePath = "./config/dataset/Text/hanlp/dictionary/other/CharTable.bin.yes";

        /**
         * 词-词性-依存关系模型
         */
        public static String WordNatureModelPath = "./config/dataset/Text/hanlp/model/dependency/WordNature.txt";

        /**
         * 最大熵-依存关系模型
         */
        public static String MaxEntModelPath = "./config/dataset/Text/hanlp/model/dependency/MaxEntModel.txt";
        /**
         * CRF分词模型
         */
        public static String CRFSegmentModelPath = "./config/dataset/Text/hanlp/model/segment/CRFSegmentModel.txt";
        /**
         * HMM分词模型
         */
        public static String HMMSegmentModelPath = "./config/dataset/Text/hanlp/model/segment/HMMSegmentModel.bin";
        /**
         * CRF依存模型
         */
        public static String CRFDependencyModelPath = "./config/dataset/Text/hanlp/model/dependency/CRFDependencyModelMini.txt";
        /**
         * 分词结果是否展示词性
         */
