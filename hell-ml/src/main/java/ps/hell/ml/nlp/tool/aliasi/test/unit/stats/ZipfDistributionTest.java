...
import ps.hell.ml.nlp.tool.aliasi.stats.ZipfDistribution;
...
public class ZipfDistributionTest  {
    ...
    public void testDistro() {
        ...
        assertEquals(-( p1*ps.hell.ml.nlp.tool.aliasi.util.Math.log2(p1)
                        + p2*ps.hell.ml.nlp.tool.aliasi.util.Math.log2(p2)
                        + p3*ps.hell.ml.nlp.tool.aliasi.util.Math.log2(p3) ),
                     dist.entropy(),
                     0.0005);
