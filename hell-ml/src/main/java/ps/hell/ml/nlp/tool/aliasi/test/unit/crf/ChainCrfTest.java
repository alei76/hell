...
import ps.hell.ml.nlp.tool.aliasi.crf.ChainCrfFeatureExtractor;
import ps.hell.ml.nlp.tool.aliasi.crf.ChainCrfFeatures;
...
import ps.hell.ml.nlp.tool.aliasi.symbol.SymbolTableCompiler;
...
public class ChainCrfTest {
    ...
    static double logMarginal(ObjectToDoubleMap<int[]> otdMap,
        ...
        return ps.hell.ml.nlp.tool.aliasi.util.Math.logSumOfExponentials(xs) - logZ;
    }
    ...
    static double logZ(ObjectToDoubleMap<int[]> otdMap) {
        ...
        for (double x : otdMap.values())
            xs[idx++] = x;
        return ps.hell.ml.nlp.tool.aliasi.util.Math.logSumOfExponentials(xs);
    }
