 ...
 *
 * LingPipe's map implementation {@link ps.hell.ml.nlp.tool.aliasi.util.FastCache} is
 ...
 * ps.hell.ml.nlp.tool.aliasi.util.FastCache}, while not synchronized, is thread safe.
