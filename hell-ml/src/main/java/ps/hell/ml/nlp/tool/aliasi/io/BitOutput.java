package ps.hell.ml.nlp.tool.aliasi.io;
...
public class BitOutput {
	...
	validatePositive(n);
	long[] fibs = ps.hell.ml.nlp.tool.aliasi.util.Math.FIBONACCI_SEQUENCE;
	boolean[] buf = FIB_BUF;
	...
	*/
	...
	= new boolean[ps.hell.ml.nlp.tool.aliasi.util.Math.FIBONACCI_SEQUENCE.length+1];
