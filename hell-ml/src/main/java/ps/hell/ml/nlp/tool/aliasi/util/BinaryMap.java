...
public class BinaryMap<E> 
    ...
    class EntrySet extends AbstractSet<Entry<E,Integer>> {
        @Override
        public int size() {
            return mPositiveSet.size();
        }
    ...
    class EntrySetIterator implements Iterator<Entry<E,Integer>> {
        ...
        class PositiveMapEntry implements Entry<E,Integer> {
