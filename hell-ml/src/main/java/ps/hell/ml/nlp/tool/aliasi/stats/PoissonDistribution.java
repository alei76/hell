...
public abstract class PoissonDistribution extends AbstractDiscreteDistribution {
    ...
    private static double log2Poisson(double lambda, long k) {
        ...
        return -lambda * ps.hell.ml.nlp.tool.aliasi.util.Math.LOG2_E
            + (((double)k) * ps.hell.ml.nlp.tool.aliasi.util.Math.log2(lambda))
            - ps.hell.ml.nlp.tool.aliasi.util.Math.log2Factorial(k);
    }
