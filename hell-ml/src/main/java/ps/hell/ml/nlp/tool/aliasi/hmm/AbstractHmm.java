...
public abstract class AbstractHmm implements HiddenMarkovModel {
     ...
     * ps.hell.ml.nlp.tool.aliasi.util.Math#log2(double)} and {@link
     * #startProb(String)}.
     *
     * @param state HMM State.
	...
	return ps.hell.ml.nlp.tool.aliasi.util.Math.log2(startProb(state));
    }
     ...
     *
     * <P>This method is implemented in terms of {@link
     * ps.hell.ml.nlp.tool.aliasi.util.Math#log2(double)} and {@link #startProb(int)}.
     *
     * @param stateId Identifier of state.
     * @return Start probability of state with specified identifier.
     */
    public double startLog2Prob(int stateId) {
	return ps.hell.ml.nlp.tool.aliasi.util.Math.log2(startProb(stateId));
    }
     ...
     *
     * <P>This method is implemented in terms of {@link
     * ps.hell.ml.nlp.tool.aliasi.util.Math#log2(double)} and {@link #endProb(String)}
     *
     * @param state HMM State.
     * @return Log end probability of state.
     */
    public double endLog2Prob(String state) {
	return ps.hell.ml.nlp.tool.aliasi.util.Math.log2(endProb(state));
    }
     ...
     *
     * <P>This method is implemented in terms of {@link
     * ps.hell.ml.nlp.tool.aliasi.util.Math#log2(double)} and {@link #endProb(int)}
     *
     * @param stateId Identifier of state.
     * @return End probability of state with specified identifier.
     */
    public double endLog2Prob(int stateId) {
	return ps.hell.ml.nlp.tool.aliasi.util.Math.log2(endProb(stateId));
    }
	...
	return ps.hell.ml.nlp.tool.aliasi.util.Math.log2(transitProb(source,target));
    }
	...
	return ps.hell.ml.nlp.tool.aliasi.util.Math.log2(transitProb(sourceId,targetId));
    }
	...
	return ps.hell.ml.nlp.tool.aliasi.util.Math.log2(emitProb(stateId,emission));
    }
	...
	return ps.hell.ml.nlp.tool.aliasi.util.Math.log2(emitProb(state,emission));
    }
