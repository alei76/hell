...
public class TrieCharSeqCounter implements CharSeqCounter {
    ...
    public char[] observedCharacters() {
        return ps.hell.ml.nlp.tool.aliasi.util.Arrays.copy(mRootNode.outcomes(new char[] { },0,0));
    }

    public char[] charactersFollowing(char[] cs, int start, int end) {
        Strings.checkArgsStartEnd(cs,start,end);
        return ps.hell.ml.nlp.tool.aliasi.util.Arrays.copy(mRootNode.outcomes(cs,start,end));
    }
    ...
    public long count(CharSequence cSeq) {
        return count(ps.hell.ml.nlp.tool.aliasi.util.Arrays.toArray(cSeq),0,cSeq.length());
    }
    ...
    public long extensionCount(CharSequence cSeq) {
        return mRootNode.contextCount(ps.hell.ml.nlp.tool.aliasi.util.Arrays.toArray(cSeq),0,cSeq.length());
    }
    ...
    public void incrementSubstrings(CharSequence cSeq, int count) {
        incrementSubstrings(ps.hell.ml.nlp.tool.aliasi.util.Arrays.toArray(cSeq),
                            0,cSeq.length(),count);
    }
