...
package ps.hell.ml.nlp.tool.aliasi.stats;
...
public class Statistics {
     ...
     * ps.hell.ml.nlp.tool.aliasi.util.Math#log2Gamma(double)}), and where
     * <code>&Psi;</code> is the digamma function defined in {@link
     * ps.hell.ml.nlp.tool.aliasi.util.Math#digamma(double)}.
     *
    ...
    public static double klDivergenceDirichlet(double[] xs, double[] ys) {
        ...
        double divergence
            = (logGamma(sumXs)
               - logGamma(sumYs));
        double digammaSumXs = ps.hell.ml.nlp.tool.aliasi.util.Math.digamma(sumXs);
        for (int i = 0; i < xs.length; ++i) {
            divergence +=
                (logGamma(ys[i])
                 - logGamma(xs[i]))
                + (xs[i] - ys[i]) * (ps.hell.ml.nlp.tool.aliasi.util.Math.digamma(xs[i]) - digammaSumXs);
        }
        return divergence;
    }
    ...
    static double logGamma(double x) {
        return ps.hell.ml.nlp.tool.aliasi.util.Math.log2Gamma(x)
            / ps.hell.ml.nlp.tool.aliasi.util.Math.log2(Math.E);
    }
    ...
    public static double klDivergence(double[] p, double[] q) {
        ...
        for (int i = 0; i < len; ++i) {
            if (p[i] > 0.0 && p[i] != q[i])
                divergence += p[i] * ps.hell.ml.nlp.tool.aliasi.util.Math.log2(p[i] / q[i]);
        }
        return divergence;
    }
     ...
     * Illegal argument exception if the matrix is not rectangular
    ...
    public static double[] normalize(double[] probabilityRatios) {
        ...
        double sum = ps.hell.ml.nlp.tool.aliasi.util.Math.sum(probabilityRatios);
        if (sum <= 0.0) {
    ...
    public static double mean(double[] xs) {
        return ps.hell.ml.nlp.tool.aliasi.util.Math.sum(xs) / (double) xs.length;
    }
    ...
    public static double dirichletLog2Prob(double alpha, double[] xs) {
        ...
        int k = xs.length;
        // normalizing term
        double result = ps.hell.ml.nlp.tool.aliasi.util.Math.log2Gamma(k * alpha)
            - k * ps.hell.ml.nlp.tool.aliasi.util.Math.log2Gamma(alpha);
        double alphaMinus1 = alpha - 1;
        for (int i = 0; i < k; ++i)
            result += alphaMinus1 * ps.hell.ml.nlp.tool.aliasi.util.Math.log2(xs[i]);
        return result;
    }
    ...
    public static double dirichletLog2Prob(double[] alphas, double[] xs) {
        ...
        for (int i = 0; i < alphas.length; ++i) {
            alphaSum += alphas[i];
            result -= ps.hell.ml.nlp.tool.aliasi.util.Math.log2Gamma(alphas[i]);
        }
        result += ps.hell.ml.nlp.tool.aliasi.util.Math.log2Gamma(alphaSum);
        for (int i = 0; i < k; ++i)
            result += (alphas[i] - 1) * ps.hell.ml.nlp.tool.aliasi.util.Math.log2(xs[i]);
        return result;
    }
