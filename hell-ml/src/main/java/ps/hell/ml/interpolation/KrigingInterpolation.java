...
import ps.hell.ml.interpolation.variagram.PowVariogram;
import ps.hell.ml.interpolation.variagram.Variogram;
...
public class KrigingInterpolation {
    ...
    public KrigingInterpolation(double[][] x, double[] y, Variogram variogram, double[] error) {
        ...
        LUDecomposition2 lu = new LUDecomposition2(v, true);
        lu.solve(yvi);
    }
