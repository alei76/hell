...
package ps.hell.ml.statistics.distibution.test;

import org.junit.*;
import ps.hell.math.base.MathBase;
import ps.hell.ml.statistics.distibution.BernoulliDistribution;
...
public class BernoulliDistributionTest {
    ...
    public void testEntropy() {
        ...
        BernoulliDistribution instance = new BernoulliDistribution(0.3);
        instance.rand();
        assertEquals(-0.3*MathBase.log2(0.3) - 0.7*MathBase.log2(0.7), instance.entropy(), 1E-7);
    }
