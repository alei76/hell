...
import ps.hell.ml.forest.regression.RBFNetwork;
import ps.hell.math.base.MathBase;
import ps.hell.math.base.persons.rbf.RadialBasisFunction;
import ps.hell.ml.statistics.validation.*;
...
public class ValidationTest {
    ...
    public void testTest_3args_2() {
        ...
        try {
            ...
            RadialBasisFunction[] rbf = MlUtils.learnGaussianRadialBasis(x, centers, 2);
    ...
    public void testBootstrap_4args_1() {
        ...
        try {
            ...
            System.out.println("100-fold bootstrap accuracy average = " + MathBase.mean(accuracy));
            System.out.println("100-fold bootstrap accuracy std.dev = " + MathBase.sd(accuracy));
        } catch (Exception ex) {
            System.err.println(ex);
        }
    }
    ...
    public void testBootstrap_4args_2() {
        ...
        try {
            ...
            System.out.println("100-fold bootstrap RMSE average = " + MathBase.mean(rmse));
            System.out.println("100-fold bootstrap RMSE std.dev = " + MathBase.sd(rmse));
        } catch (Exception ex) {
            System.err.println(ex);
        }
    }
    ...
    public void testBootstrap_5args_1() {
        ...
        try {
            ...
            double[] avg = MathBase.colMean(results);
            for (int j = 0; j < measures.length; j++) {
    ...
    public void testBootstrap_5args_2() {
        ...
        try {
            ...
            RegressionMeasure[] measures = {new RMSE(), new AbsoluteDeviation()};
            double[][] results = Validation.bootstrap(100, trainer, x, y, measures);
            System.out.println("100-fold bootstrap RMSE average = " + MathBase.mean(results[0]));
            System.out.println("100-fold bootstrap RMSE std.dev = " + MathBase.sd(results[0]));
            System.out.println("100-fold bootstrap AbsoluteDeviation average = " + MathBase.mean(results[1]));
            System.out.println("100-fold bootstrap AbsoluteDeviation std.dev = " + MathBase.sd(results[1]));
        } catch (Exception ex) {
            System.err.println(ex);
        }
    }
