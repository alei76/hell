...
public class Benchmark {
	...
	public static void demo1() {
		...
		// cern.jet.random.engine.RandomEngine engine = new
		// cern.jet.random.engine.MersenneTwister();
		//
		// // your favourite distribution goes here
		// cern.jet.random.AbstractDistribution dist = new
		// cern.jet.random.Gamma(alpha,lambda,engine);
		//
		// // collect random numbers and print statistics
		// int size = 100000;
		// cern.colt.list.DoubleArrayList numbers = new
		// cern.colt.list.DoubleArrayList(size);
	 ...
	 * 
	 * @param args
	 *            [0] the number of random numbers to be generated per subclass.
	 * @param args
	 *            [1] <tt>true</tt> prints each generated number, <tt>false</tt>
	 ...
	 */
	public static void random(int size, boolean print, double mean,
			String generatorName) {
		System.out.println("Generating " + size
				+ " random numbers per distribution...\n");
		 ...
		 */
		randomInstance(size, print,
				new Poisson(mean, (RandomEngine) gen.clone()));
		/*
		 ...
		 * 
		 * int probs = 10000; double[] pdf = new double[probs]; for (int i=0;
		 * i<probs; i++) pdf[i]=i*i; // prepare f(x)=x^2 distrib.
		 * randomInstance(size,print,new
	 ...
	 */
	public static void randomInstance(int size, boolean print,
	 ...
	 * distribution.
	 */
	public static void test2(int size, AbstractDistribution a,
