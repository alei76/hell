 ...
 * <dt>
 * This is a port of <tt>lsk.c</tt> from the <A
...
public class Logarithmic extends AbstractContinousDistribution {
	...
	protected static Logarithmic shared = new Logarithmic(0.5,
	...
	public double nextDouble(double a) {
		 ...
		 ******************************************************************
		 * * The algorithm combines Inversion and Transformation. * It is based
		 * on the following fact: A random variable X from * the Logarithmic
