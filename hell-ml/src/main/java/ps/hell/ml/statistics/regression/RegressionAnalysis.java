...
//
//	/**
//	 * Returns the sum of squared residuals of the simple linear regression
//	 * model: y = a + bx.
//	 *
//	 * @param data
//	 *            (the data set)
...
//	 *            (chosen x-attribute)
//	 * @param slope
//	 *            (slope determined by simple linear regression model)
//	 * @param intercept
//	 *            (intercept determined by simple linear regression model)
//	 *
...
//	 * squared residuals is already calculated. This works for either a simple
//	 * or a multiple linear regression model.
//	 *
//	 * @param data
//	 *            (the data set)
//	 * @param ssr
...
//	 * @param k
//	 *            (the number of coefficients in the model: k>=2)
...
//			Attribute chosen, double slope, double intercept, int df)
//			throws Exception {
...
//
//		/*
//		 * put data into 2-D array with 2 columns first column is value of
//		 * chosen attribute second column is constant (1's)
//		 */
...
//
//		/*
//		 * linear algebra calculation: covariance matrix = mse * (XtX)^-1
//		 * diagonal of covariance matrix is square of standard error of
//		 * coefficients
//		 */
...
//	 * the constant coefficient. The standard error array is used to calculate
//	 * the t-statistics.
//	 *
//	 * @param data
//	 *            (the data set
//	 * @param selected
//	 *            (flags indicating variables used in the regression)
//	 * @param ssr
//	 *            (sum of squared residuals)
//	 * @param n
//	 *            (number of instances)
//	 * @param k
//	 *            (number of coefficients; includes constant)
//	 *
...
//	 *
//	 * @param coef
//	 *            (array holding the value of each coefficient)
//	 * @param stderror
//	 *            (array holding each coefficient's standard error)
//	 * @param k
//	 *            (number of coefficients, includes constant)
//	 * @return array of t-statistics of coefficients
//	 */
//	public static double[] calculateTStats(double[] coef, double[] stderror,
//			int k) {
//		double[] result = new double[k];
//		for (int i = 0; i < k; i++) {
