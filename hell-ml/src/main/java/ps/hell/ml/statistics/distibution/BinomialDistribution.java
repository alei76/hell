...
public class BinomialDistribution extends DiscreteDistribution {
    ...
    public double p(int k) {
        if (k < 0 || k > n) {
            ...
            return MathBase.floor(0.5 + Math.exp(MathBase.logFactorial(n) - MathBase.logFactorial(k) - MathBase.logFactorial(n - k))) * Math.pow(p, k) * Math.pow(1.0 - p, n - k);
        }
    }
    ...
    public double logp(int k) {
        if (k < 0 || k > n) {
            ...
            return MathBase.logFactorial(n) - MathBase.logFactorial(k)
                    - MathBase.logFactorial(n - k) + k * MathBase.log(p) + (n - k) * MathBase.log(1.0 - p);
        }
    }
    ...
    class Patchwork implements RandomNumberGenerator {
        ...
        public Patchwork(double p) {
            ...
            l_pq = Math.log(p);
            c_pm = mode * l_pq - MathBase.logFactorial(mode) - MathBase.logFactorial(n - mode);
        ...
        public int rand() {
            ...
            for (;;) {
                ...
                if (MathBase.log(W) <= X * l_pq - MathBase.logFactorial(X) - MathBase.logFactorial(n - X) - c_pm) {
                    return X;
                }
            }
        }
        ...
        private double f(int k, int n, double l_pq, double c_pm) {
            return MathBase.exp(k * l_pq - MathBase.logFactorial(k) - MathBase.logFactorial(n - k) - c_pm);
        }
    }
    ...
    class ModeSearch implements RandomNumberGenerator {
        ...
        public ModeSearch(double p) {
            ...
            r1 = p / (1.0 - p);
            modeValue = MathBase.exp(MathBase.logFactorial(n) - MathBase.logFactorial(mode) - MathBase.logFactorial(n - mode) + mode * MathBase.log(p) + (n - mode) * MathBase.log(1. - p));
        }
