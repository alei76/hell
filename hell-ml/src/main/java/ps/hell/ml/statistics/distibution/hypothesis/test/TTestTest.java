...
package ps.hell.ml.statistics.distibution.hypothesis.test;

import org.junit.*;
import ps.hell.math.base.MathBase;
import ps.hell.ml.statistics.distibution.hypothesis.TTest;
...
public class TTestTest {
    ...
    public void testTestCorr() {
        ...
        TTest result = TTest.test(MathBase.cor(x,y), x.length-2);
