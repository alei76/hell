...
public class BetaDistribution extends AbstractDistribution implements ExponentialFamily {
    ...
    public BetaDistribution(double[] data) {
        ...
        mean = MathBase.mean(data);
        var = MathBase.var(data);
            ...
            switch (method) {
                case BB:
                    ...
                    while (true) {
                        ...
                        /* Step 5 */
                        X = MathBase.equals(am, alpha) ? w / (bm + w) : bm / (bm + w);
                        break;
                    }
                    ...
                    while (true) {
                        ...
                        if (u1 < 0.5) {
                            ...
                            if (v > 80.0) {
                                ...
                                X = MathBase.equals(am, alpha) ? 1.0 : 0.0;
                                break;
                            } else {
                                w = am * Math.exp(v);
                                ...
                                /* Step 6_a */
                                X = !MathBase.equals(am, alpha) ? bm / (bm + w) : w / (bm + w);
                                break;
                            }
                        } else {
                            /* Step 3 */
