...
/**
 * 一阶线性条件随机场。一个条件随机场是一个
*类型的歧视无向概率图形模型。它是最
*通常用于标记或顺序数据的解析。< p > CRF是一个马尔可夫
*随机领域是有区别地训练。因此没有必要
*模型分布总是观察到的变量,这使得它
*可以包括任意观测到的复杂特性
*变量进入模型
...
public class CRF implements SequenceLabeler<double[]> {
     ...
     * @param eta the learning rate of potential function. 潜在的
     */
     ...
     * Constructor.
     *
     * @param numFeatures the number of sparse binary features.稀疏二进制特征的数量。
     * @param numClasses the number of classes.类的数量
     * @param eta the learning rate of potential function.学习的速度势函数
     */
