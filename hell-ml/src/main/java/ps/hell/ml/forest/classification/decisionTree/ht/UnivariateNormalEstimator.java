...
package ps.hell.ml.forest.classification.decisionTree.ht;
...
public class UnivariateNormalEstimator {
  ...
  public double[][] predictIntervals(double conf) {
    ...
    double val = MathBase.normalInverse(1.0 - (1.0 - conf) / 2.0);
  ...
  public double predictQuantile(double percentage) {
    ...
    return m_Mean + MathBase.normalInverse(percentage) * Math.sqrt(m_Variance);
  }
