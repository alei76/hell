...
import ps.landerbuluse.ml.forest.classification.NeuralNetwork;
...
public class NeuralNetworkTest {
    ...
    public void testSegment() {
        ...
        try {
            ...
            int p = x[0].length;
            double[] mu = MathBase.colMin(x);
            double[] sd = MathBase.colMax(x);
            ...
            NeuralNetwork net = new NeuralNetwork(NeuralNetwork.ErrorFunction.CROSS_ENTROPY, NeuralNetwork.ActivationFunction.SOFTMAX, x[0].length, 30, MathBase.max(y)+1);
            for (int j = 0; j < 20; j++) {
                net.learn(x, y);
            }
    ...
    public void testSegmentLMS() {
        ...
        try {
            ...
            NeuralNetwork net = new NeuralNetwork(NeuralNetwork.ErrorFunction.LEAST_MEAN_SQUARES, NeuralNetwork.ActivationFunction.LOGISTIC_SIGMOID, x[0].length, 30, MathBase.max(y)+1);
            for (int j = 0; j < 30; j++) {
                net.learn(x, y);
            }
            int error = 0;
    ...
    public void testUSPS() {
        ...
        try {
            ...
            NeuralNetwork net = new NeuralNetwork(NeuralNetwork.ErrorFunction.CROSS_ENTROPY, NeuralNetwork.ActivationFunction.SOFTMAX, x[0].length, 40, MathBase.max(y)+1);
            for (int j = 0; j < 30; j++) {
                net.learn(x, y);
            }
            int error = 0;
    ...
    public void testUSPSLMS() {
        ...
        try {
            ...
            NeuralNetwork net = new NeuralNetwork(NeuralNetwork.ErrorFunction.LEAST_MEAN_SQUARES, NeuralNetwork.ActivationFunction.LOGISTIC_SIGMOID, x[0].length, 40, MathBase.max(y)+1);
            for (int j = 0; j < 30; j++) {
                net.learn(x, y);
            }
            int error = 0;
