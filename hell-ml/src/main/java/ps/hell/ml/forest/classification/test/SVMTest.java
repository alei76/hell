...
public class SVMTest {
    ...
    public void testLearn() {
        ...
        try {
            ...
            SVM<double[]> svm = new SVM<double[]>(new LinearKernel(), 10.0, MathBase.max(y)+1, SVM.Multiclass.ONE_VS_ALL);
            svm.learn(x, y);
            svm.learn(x, y);
            svm.finish();
            ...
            svm = new SVM<double[]>(new GaussianKernel(1), 1.0, MathBase.max(y)+1, SVM.Multiclass.ONE_VS_ALL);
            svm.learn(x, y);
            svm.learn(x, y);
            svm.finish();
            ...
            svm = new SVM<double[]>(new GaussianKernel(1), 1.0, MathBase.max(y)+1, SVM.Multiclass.ONE_VS_ONE);
            svm.learn(x, y);
            svm.learn(x, y);
            svm.finish();
            ...
            svm = new SVM<double[]>(new PolynomialKernel(2), 1.0, MathBase.max(y)+1, SVM.Multiclass.ONE_VS_ALL);
            svm.learn(x, y);
            svm.learn(x, y);
            svm.finish();
    ...
    public void testSegment() {
        ...
        try {
            ...
            SVM<double[]> svm = new SVM<double[]>(new GaussianKernel(8.0), 5.0, MathBase.max(y)+1, SVM.Multiclass.ONE_VS_ALL);
            svm.learn(x, y);
            svm.finish();
    ...
    public void testUSPS() {
        ...
        try {
            ...
            SVM<double[]> svm = new SVM<double[]>(new GaussianKernel(8.0), 5.0, MathBase.max(y)+1, SVM.Multiclass.ONE_VS_ONE);
            svm.learn(x, y);
            svm.finish();
            ...
            for (int i = 0; i < x.length; i++) {
                int j = MathBase.randomInt(x.length);
                svm.learn(x[j], y[j]);
            }
