package ps.hell.ml.forest.classification.decisionTree.randomForest;
...
public class Client {
    public static void main(String[] args) {
        String filePath = Client.class.getResource("input.txt").toString().replace("file:/", "").replace("bin", "src");
