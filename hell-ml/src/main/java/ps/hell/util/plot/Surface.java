...
public class Surface extends Plot {
    ...
    public static PlotCanvas plot(double[][] z) {
        double[] lowerBound = {0, 0, MathBase.min(z)};
        double[] upperBound = {z.length, z[0].length, MathBase.max(z)};
    ...
    public static PlotCanvas plot(double[] x, double[] y, double[][] z) {
        double[] lowerBound = {MathBase.min(x), MathBase.min(y), MathBase.min(z)};
        double[] upperBound = {MathBase.max(x), MathBase.max(y), MathBase.max(z)};
