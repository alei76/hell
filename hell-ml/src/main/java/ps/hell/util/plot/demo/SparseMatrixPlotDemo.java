 ...
 *******************************************************************************/
package ps.hell.util.plot.demo;
...
public class SparseMatrixPlotDemo extends JPanel {
    public SparseMatrixPlotDemo() {
        ...
        try {
            SparseMatrix m1 = parser.parse(this.getClass().getResourceAsStream("/smile/demo/data/matrix/08blocks.txt"));
            PlotCanvas canvas = SparseMatrixPlot.plot(m1);
            canvas.setTitle("08blocks");
            add(canvas);

            SparseMatrix m2 = parser.parse(this.getClass().getResourceAsStream("/smile/demo/data/matrix/mesh2em5.txt"));
