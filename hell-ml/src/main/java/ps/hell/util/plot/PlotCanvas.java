...
import ps.hell.ml.forest.model.projection.PCA;
import ps.hell.math.base.MathBase;
import ps.hell.util.plot.swing.Button;
import ps.hell.util.plot.swing.FileChooser;
import ps.hell.util.plot.swing.Printer;
import ps.hell.util.plot.swing.Table;
...
public class PlotCanvas extends JPanel {
    ...
    private class MathCanvas extends JComponent implements Printable, ComponentListener, MouseListener, MouseMotionListener, MouseWheelListener, ActionListener {
        ...
        public void paintComponent(java.awt.Graphics g) {
            ...
            if (mouseDraggingX >= 0 && mouseDraggingY >= 0) {
                g.drawRect(MathBase.min(mouseClickX, mouseDraggingX),
                        MathBase.min(mouseClickY, mouseDraggingY),
                ...
                if (mouseDraggingX != -1 && mouseDraggingY != -1) {
                    ...
                    if (base.dimension == 2) {
                        if (Math.abs(e.getX() - mouseClickX) > 20 && Math.abs(e.getY() - mouseClickY) > 20) {
                            ...
                            if (MathBase.min(sc1[0], sc2[0]) < base.upperBound[0]
                                    && MathBase.max(sc1[0], sc2[0]) > base.lowerBound[0]
                                    && MathBase.min(sc1[1], sc2[1]) < base.upperBound[1]
                                    && MathBase.max(sc1[1], sc2[1]) > base.lowerBound[1]) {

                                base.lowerBound[0] = MathBase.max(base.lowerBound[0], MathBase.min(sc1[0], sc2[0]));
                                base.upperBound[0] = MathBase.min(base.upperBound[0], MathBase.max(sc1[0], sc2[0]));
                                base.lowerBound[1] = MathBase.max(base.lowerBound[1], MathBase.min(sc1[1], sc2[1]));
                                base.upperBound[1] = MathBase.min(base.upperBound[1], MathBase.max(sc1[1], sc2[1]));
    ...
    private class SaveAction extends AbstractAction {
        ...
        public SaveAction() {
            super("Save", new ImageIcon(System.getProperty("usr.dir")+"/config/plot/images/save16.png"));
        }
    ...
    private class PrintAction extends AbstractAction {
        ...
        public PrintAction() {
            super("Print", new ImageIcon(System.getProperty("usr.dir")+"/config/images/print16.png"));
        }
    ...
    private class ZoomInAction extends AbstractAction {
        ...
        public ZoomInAction() {
            super("Zoom In", new ImageIcon(System.getProperty("usr.dir")+"/config/images/zoom-in16.png"));
        }
    ...
    private class ZoomOutAction extends AbstractAction {
        ...
        public ZoomOutAction() {
            super("Zoom Out", new ImageIcon(System.getProperty("usr.dir")+"/config/images/zoom-out16.png"));
        }
    ...
    private class ResetAction extends AbstractAction {
        ...
        public ResetAction() {
            super("Reset", new ImageIcon(System.getProperty("usr.dir")+"/config/images/refresh16.png"));
        }
    ...
    private class EnlargePlotAreaAction extends AbstractAction {
        ...
        public EnlargePlotAreaAction() {
            super("Enlarge", new ImageIcon(System.getProperty("usr.dir")+"/config/images/resize-larger16.png"));
        }
    ...
    private class ShrinkPlotAreaAction extends AbstractAction {
        ...
        public ShrinkPlotAreaAction() {
            super("Shrink", new ImageIcon(System.getProperty("usr.dir")+"/config/images/resize-smaller16.png"));
        }
    ...
    private class IncreaseWidthAction extends AbstractAction {
        ...
        public IncreaseWidthAction() {
            super("Increase Width", new ImageIcon(System.getProperty("usr.dir")+"/config/images/increase-width16.png"));
        }
    ...
    private class IncreaseHeightAction extends AbstractAction {
        ...
        public IncreaseHeightAction() {
            super("Increase Height", new ImageIcon(System.getProperty("usr.dir")+"/config/images/increase-height16.png"));
        }
    ...
    private class DecreaseWidthAction extends AbstractAction {
        ...
        public DecreaseWidthAction() {
            super("Decrease Width", new ImageIcon(System.getProperty("usr.dir")+"/config/images/decrease-width16.png"));
        }
    ...
    private class DecreaseHeightAction extends AbstractAction {
        ...
        public DecreaseHeightAction() {
            super("Decrease Height", new ImageIcon(System.getProperty("usr.dir")+"/config/images/decrease-height16.png"));
        }
    ...
    private class PropertyAction extends AbstractAction {
        ...
        public PropertyAction() {
            super("Properties", new ImageIcon(System.getProperty("usr.dir")+"/config/images/property16.png"));
        }
    ...
    public ScatterPlot points(String id, double[]... data) {
        ...
        double[] lowerBound = MathBase.colMin(data);
        double[] upperBound = MathBase.colMax(data);
    ...
    public LinePlot line(String id, double[] y) {
        double[] lowerBound = {0, MathBase.min(y)};
        double[] upperBound = {y.length, MathBase.max(y)};
        extendBound(lowerBound, upperBound);
    ...
    public Histogram histogram(String id, double[] data, Color color) {
        ...
        double[] lowerBound = {MathBase.min(data), 0};
        double[] upperBound = {MathBase.max(data), 0};
    ...
    public Histogram histogram(String id, int[] data, Color color) {
        ...
        double[] lowerBound = {MathBase.min(data) - 0.5, 0};
        double[] upperBound = {MathBase.max(data) + 0.5, 0};
        double[][] freq = histogram.getHistogram();
        for (int i = 0; i < freq.length; i++) {
            if (freq[i][1] > upperBound[1]) {
                upperBound[1] = freq[i][1];
