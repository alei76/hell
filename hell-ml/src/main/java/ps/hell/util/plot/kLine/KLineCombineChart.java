package ps.hell.util.plot.kLine;
...
//            Day day = new Day(Integer.parseInt(bean.date.substring(6)), Integer.parseInt(bean.date.substring(4,6)),
//                    Integer.parseInt( bean.date.substring(0,4)));
