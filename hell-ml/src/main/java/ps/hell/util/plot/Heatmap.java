...
public class Heatmap extends Plot {
    ...
    public void paint(Graphics g) {
        ...
        g.drawTextBaseRatio(String.valueOf(MathBase.round(max, decimal)), 0.0, 1.0, start);
        ...
        g.drawTextBaseRatio(String.valueOf(MathBase.round(min, decimal)), 0.0, 0.0, start);
