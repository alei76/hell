...
public class HexmapDemo extends JPanel {
    ...
    public static void main(String[] args) {
        ...
        try {
            AttributeDataset train = parser.parse("USPS Train", HexmapDemo.class.getResourceAsStream("/smile/demo/data/usps/zip.train"));
            ...
            for (int i = 0; i < m*n; i++) {
                for (int j = 0; j < m*n; j++) {
                    proximity[i][j] = MathBase.distance(map[i/n][i%n], map[j/n][j%n]);
                }
            }
