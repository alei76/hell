...
public class Contour extends Plot {
    ...
    public void paint(Graphics g) {
        ...
        if (colors != null) {
            ...
            g.drawTextBaseRatio(String.valueOf(MathBase.round(levels[levels.length-1], decimal)), 0.0, 1.0, start);
            ...
            g.drawTextBaseRatio(String.valueOf(MathBase.round(levels[0], decimal)), 0.0, 0.0, start);
